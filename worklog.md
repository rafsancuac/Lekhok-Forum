...
\n
## Task 180 — session343: hr343 register-'W'-সম্পূর্ণ-কীবোর্ড-parity + sfs343 ওভারলে-W-সারি-ধ্বংসাত্মক-টোন (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609251734`); রাউন্ড-আরম্ভে HEAD=origin=`8ab1f82` (session342), clean-tree, BEHIND=০/AHEAD=০; agent-browser-QA বেসলাইন সবুজ (local home-200 {লেখক ফোরাম টাইটেল} + epaper-200 + admin-গেট 302→/admin/login + s342-সুইট ৩৬/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ-style.css-এ + epaper-200 + প্রোড-অ্যাডমিন-৩০৭-cred-gated + session342/341/340/339/330-মার্কার-পাবলিক-পাঠে-শূন্য = 8ab1f82-ডিপ্লয়-প্রমাণ — PLANS session342-প্রস্তাব-①-যাচাই-সম্পন্ন)। বাগ-শূন্য-স্থিতিশীল → PLANS session342-নোটের **প্রস্তাব-②-প্রথম-বিকল্প গ্রহণ** (register-'W'-সম্পূর্ণ-কীবোর্ড-parity — দ্বি-বার-স্থগিত-পরে এ-রাউন্ডে মূল্যায়ন-সম্পন্ন-গৃহীত: ধ্বংসাত্মক-সতর্কতা দ্বি-চাপ-আর্ম/ওয়াইপ-রীতিতে-মেটে + নথিভুক্তকরণ ওভারলে-স্ব-ডকুমেন্টেড; getHints-অ্যারে-সেট-সমতা = অপ্রয়োগিত; csv-চতুর্থ-মোড = অপ্রয়োগিত; ③-স্থায়ী-স্থগিত; ④-গেটেড)।
- **[Mandatory-ফিচার] hr343 (admin/home-reorder.ejs — শেয়ার্ড-IIFE-অভ্যন্তরে):** ovRows330-স্ট্যাটিক-সারি ['W', বর্ণনা, হিন্ট] ('S'-পরে-'?'-পূর্বে — সহায়িকা-শেষ-রীতি-অটুট) — **৮→৯-সারি (ওভারলে-গণনা-সুইট-বিবর্তন-জুটি — s330/s333/s334/s335/s336/s337/s338/s339/s340/s341/s342-গণনা-৮→৯ + s339-গার্ড-বিবর্তন {register-'W'-কল-শূন্য + W-সারি-উপস্থিতি-দ্বি-assert}); W-keydown (s320/s324-keydown-রীতি — .hr-aria-copy-ফোকাস × মডিফায়ার-বর্জন × বাটন-গেট clearBtn339-উপস্থিত = store≥১ × tip-খোলা — শূন্যে নীরব): প্রথম-W = আর্ম (পয়েন্টার-সম-পথ — armed339 + .hr339-armed + label339 + tmr339-৩s-স্বয়ং-নিরামড) × দ্বিতীয়-W = wipe339-এক-উৎস (q339h.clears-গণনা-সহ — parity-প্রমাণ) — পয়েন্টার↔কীবোর্ড-সম-স্টেট-মেশিন (মিশ্র-পথ-সমতা W-আর্ম→ক্লিক-ওয়াইপ ∨ ক্লিক-আর্ম→W-ওয়াইপ); **ত্রি-মোড়ক-জীবন্ত-সিঙ্ক** {label339-মোড়ক (labelOrig343-চেইন) + openOv330-মোড়ক (ooOrig343 — খোলা-পথে-আর্মড-পুনঃপ্রয়োগ) + q337h.clearStore-মোড়ক (clrOrig343 — ওয়াইপ-পথে-লেবেল-স্কিপ-গোটচা-সংশোধন)} — syncW343-এক-উৎস (ওভারলে-W-সারি .hr343-armed-টগল — রি-রেন্ডার-বিহীন — ৫ম-MO-নিষিদ্ধ-চুক্তি-অটুট MO=৪); **trOrig343-কেননিকাল-রি-রাইট** (সর্ব-বহিঃস্থ-টিপ-মোড়ক — প্রতি-রেন্ডারে kbd-line = kbdLine334() — W-স্বয়ং-অন্তর্ভুক্ত — append-ক্রম-নিরপেক্ষ — live==line()-সর্বদা); mkLi330-এক-লাইন-সম্প্রসারণ (data-hr343-w-মার্কার — নির্মাতা-এক-উৎস-অটুট); q333h.register-অব্যবহৃত-অটুট (স্ট্যাটিক-সারি-রীতি); __hrAria343QA {press, arms, wipes, syncs, last, btn(), armed(), syncW(), err}।
- **[Mandatory-স্টাইল] sfs343 (home-reorder.ejs ইনলাইন-<style> session343-ব্লক — cascade-অবস্থান session342-পরে):** ওভারলে-W-সারি-ধ্বংসাত্মক-টোন (data-hr343-w-হুক — লাল-পরিবার rgba(220,38,38)-সম-পরিবার — .hr330-k-চিপ + .hr330-d-বর্ণনা) + **আর্মড-জীবন্ত-সিঙ্ক-অবস্থা .hr343-armed** (সলিড-লাল-চিপ + বোল্ড-বর্ণনা — নিশ্চিতকরণ-তাড়না — পয়েন্টার/W-দ্বি-পথ-সম-সিঙ্ক) + ≤640px-কম্প্যাক্ট (min-width 16px — ডেস্ক-২০px-ব্যান্ড-বৈচিত্র্য); হেক্স-শূন্য rgba-only; বিদ্যমান-সারি-অস্পৃশ্য — নতুন-টোন-কেবল; সর্ব-ব্যান্ড; MO=৪-অটুট; style.css = session343/342-শূন্য (admin-CSS-চুক্তি) + session334 ×২-অটুট।
- **টেস্ট:** নতুন tests/s343-suite.sh **৩৫/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×১১ + SSR ×৩ + hr343-ই২ই ×১৩ — রেজিস্ট্রি-৯-সারি + W-হিন্ট/kbd-লাইন + ওভারলে-৯-সারি-৮ম-অবস্থান + গেট-নীরবতা + সিড-বাটন + W-আর্ম + W-ওয়াইপ {q339h.clears-এক-উৎস-প্রমাণ} + মিশ্র-পথ-সমতা {সারি-শ্রেণি true→false-দ্বি-পথ} + ৩s-স্বয়ং-নিরামড + আর্মড-সিঙ্ক-অন/অফ + সর্ব-হুক-ত্রুটি-শূন্য; মোবাইল ×২ {16px-ব্যান্ড}; পরিষ্কারণ-চুক্তি + কনসোল-কাউন্টার + নেট-শূন্য)। **সুইট-বিবর্তন:** scripts/s343-suite-evolution.py — ১১-সুইটে ৫৪-assert (৮→৯-গণনা + s339-গার্ড-বিবর্তন + s333/s334-নিবন্ধন-পরবর্তী-গণনা ৯→১০/১১ + s335/s336-রিপ্লে-গণনা)। **রিগ্রেশন সর্ব-গ্রিন (১২-সুইট — ৫৩০-পাস-শূন্য-ব্যর্থতা):** s330 ৫৫ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫।
- **গোটচা ×৩ (নতুন — PLANS-ডক-কৃত):** ① **ওয়াইপ-পথে-লেবেল-স্কিপ** — wipe339 → clearStore-মোড়ক (hr339/hr342-ensure) → বাটন-অপসারণ-পূর্বে → disarm339-এ b339d=null → label339(false)-স্কিপ → ওভারলে-W-সারি-শ্রেণি-স্টেল → **clrOrig343-মোড়কে-সংশোধন** (সর্ব-ওয়াইপ-পথে শ্রেণি-অপসারণ-নিশ্চিত — কোড-চুক্তি-সংশোধন) ② **append-ক্রম-অর্থবিদ্যা** — নতুন-রেজিস্ট্রি-কীর হিন্ট appendHint334-স্তূপে-শেষে-যুক্ত (রেজিস্ট্রি-ক্রম-ভাঙা — live≠line) → **কেননিকাল-রি-রাইট-রেন্ডার-সাইটে-সমাধান** (trOrig343 — kbdLine334-এক-উৎস) — append-সাইট-সংখ্যা ১০-অটুট (নতুন-সাইট appendHint334-কল-নয়) ③ **রেসিপি-পূর্ব-কপি-বাটন-অনুপস্থিতি** — home-reorder-এ .hr-aria-copy = USER_FEED-সারি-নির্বাচন-পরবর্তী — W-e2e-রেসিপিতে সারি-ক্লিক-প্রথম (s342-রীতি-পুনঃপ্রমাণ)। উত্তরাধিকার-গোটচা ×৮-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা।
- **প্যাচ/ডক:** scripts/s343-suite-evolution.py (১১-সুইট — প্রতি-assert-একবার-count-যাচাই) + s343-docs.py (এ-ফাইল-ত্রয়ী); PLANS session343-নোটে session344-প্রস্তাব ×৪ (প্রোড-স্পট + getHints-অ্যারে-সেট-সমতা/csv-চতুর্থ-মোড/ওভারলে-নেভিগেশন + গাটার-গবেষণা + bot-সিঙ্ক-গেটেড)।

## Task 181 — session344: hr344 getHints('all')-সর্ব-মোড-শর্টহ্যান্ড + .hr344-bar/.hr344-abtn/.hr344-chip সর্ব-মোড-রপ্তাই-বার + sfs344 অ্যাম্বার-স্টাইল (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609251836`); রাউন্ড-আরম্ভে HEAD=origin=`61e5abe` (session343), clean-tree, BEHIND=০/AHEAD=০; agent-browser-QA বেসলাইন সবুজ (local home-200 {লেখক ফোরাম টাইটেল} + epaper-200 + admin-গেট 302→/admin/login + s343-সুইট ৩৫/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ + epaper-200 + প্রোড-অ্যাডমিন-৩০৭-cred-gated + hr343-মার্কার-পাবলিক-পাঠে-শূন্য = 61e5abe-ডিপ্লয়-প্রমাণ — PLANS session343-নোটের প্রস্তাব-①-যাচাই-সম্পন্ন)। বাগ-শূন্য-স্থিতিশীল → PLANS session343-নোটের **প্রস্তাব-②-প্রথম-বিকল্প গ্রহণ** (getHints('all')-সর্ব-মোড-শর্টহ্যান্ড — সতর্ক-মূল্যায়ন-সম্পন্ন-গৃহীত: এক-উৎস-প্রতিনিধি-রীতিতে-নির্মাণ — অনুলিপি-লজিক-শূন্য; csv-চতুর্থ-মোড = অপ্রয়োগিত; ওভারলে-নেভিগেশন = অপ্রয়োগিত; ③-স্থায়ী-স্থগিত; ④-গেটেড)।
- **[Mandatory-ফিচার] hr344 (admin/home-reorder.ejs — শেয়ার্ড-IIFE-অভ্যন্তরে):** **getHints('all')** (getHintsOrig344-চেইন-রীতি — hr342-চুক্তি-প্রসারিত): q333h.getHints('all') = getHints(MODES344.slice(0))-এক-উৎস-প্রতিনিধি — **batch-MODES342-সমতুল্য** (দ্বি-পথ-সমতা {আকৃতি + ক্রম + স্ন্যাপশট + getmb-কাউন্টার-ডেল্টা-সমতা} — অনুলিপি-লজিক-শূন্য); অ-'all'-ইনপুট = getHintsOrig344-প্রতিনিধি-অটুট (অ্যারে = hr342; স্ট্রিং-মোড = hr341 — 'all'-ব্যতীত; মিথ্যা=RAW/সত্য=বর্তমান-মোডে = hr340; অবৈধ-স্ট্রিং = getm:invalid-অটুট — hr341/hr342-কাউন্টার-'all'-পথে-অস্পৃশ্য); প্রতি-কলে-নতুন-নেস্টেড-অবজেক্ট (hr342/hr338-কপি-সুরক্ষা-উত্তরাধিকার)। **সর্ব-মোড-রপ্তাই-বার** .hr344-bar + বাটন .hr344-abtn + কী-গণনা-চিপ .hr344-chip (স্বতন্ত্র-শ্রেণি-ত্রয়ী — s326-রীতি — .hr324-btn-গণনা-চুক্তি-অটুট): স্বতন্ত্র-বার .hr324-bar.hr344-bar (hr342-বার-রীতি); নির্মাণ = trOrig344-চেইন (hr343-পরে — সর্ব-বহিঃস্থ); গেট = বার-পরিবার-দৃশ্যমানতা (hist317.length ≥১ ∨ storeN339() ≥১ — শূন্যে নীরব); ডুপ-রক্ষা + পরিবার-শূন্যে-নিজস্ব-বার-অপসারণ (ensureAll344 এক-উৎস — চতুর্মোড়ক-জীবন্ত-সিঙ্ক: trOrig344-চেইন + persist337-মোড়ক + q337h.clearStore-মোড়ক + cycleFmt326-মোড়ক — রি-রেন্ডার-বিহীন — ৫ম-MO-নিষিদ্ধ-চুক্তি-অটুট MO=৪); **চিপ = registry-উৎস-প্রত্যক্ষ-গণনা** (syncChip344 — ovRows330-অ-শূন্য-হিন্ট-সারি — কাউন্টার-নীরব {q338h.gets/q342h.getmb-অস্পৃশ্য — সহাবস্থান-চুক্তি} — bn317a-বাংলা-সংখ্যা — aria-hidden-চাক্ষুষ-কেবল — গণনা-মোড-নিরপেক্ষ {রেজলিউশন-মান-কেবল-পরিবর্তন — কী-সেট-অভিন্ন}); বাটন-কপি = getHints('all') → JSON.stringify(…, null, 2) — রেকর্ড-বিহীন (copyHist324-রীতি) + টোস্ট + .hr344-done-ফ্ল্যাশ (১.২s); কীবোর্ড-parity ইচ্ছাকৃত-অনুপস্থিত (পয়েন্টার-কেবল — উত্তরাধিকার); __hrAria344QA {getall, copies, last, all(), chip(), abtn(), bar(), err} — সারি-শূন্যে-ও-সংজ্ঞায়িত; s343…s330-হুক-সহাবস্থান-অটুট।
- **[Mandatory-স্টাইল] sfs344 (ইনলাইন-<style> session344-ব্লক — cascade-অবস্থান session343-পরে):** **অ্যাম্বার-পরিবার** = সর্ব-মোড-শর্টহ্যান্ড-সংকেত (নীল-রিড/বেগুনি-মোড/টিল-ব্যাচ/সবুজ-সম্পাদনা/লাল-ধ্বংসাত্মক-পরিবার-বিভাজন-বৃদ্ধি — all-সংকেত) — .hr344-abtn solid-বর্ডার (শর্টহ্যান্ড-সম্পূর্ণ-রপ্তাই-রীতি) + hover/focus-visible + :active scale(0.97) + .hr344-done-ফ্ল্যাশ + .hr344-chip dashed-চিপ (নির্দেশক-নিষ্ক্রিয়-অর্থবিদ্যা — 999px-পিল) + prefers-reduced-motion + ≤640px-কম্প্যাক্ট (চিপ max-width 116px-এলিপসিস); হেক্স-শূন্য rgba-only; নতুন-উপাদান-স্টাইল-কেবল; সর্ব-ব্যান্ড; MO=৪-অটুট; style.css = session344/343/342-শূন্য (admin-CSS-চুক্তি) + session334 ×২-অটুট।
- **টেস্ট:** নতুন tests/s344-suite.sh **৩১/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×৮ {রেফারেন্স + node --check + হেক্স-শূন্য + মার্কার ×২ + cascade + style.css-চুক্তি + শ্রেণি-রেফারেন্স + MODES344-মিরর} + SSR ×৩ + hr344-ই২ই ×১২ {হুক-সহাবস্থান + all-দ্বি-পথ-সমতা {getmb-ডেল্টা-সমতা-প্রমাণ} + অ-'all'-প্রতিনিধি-অটুট + প্রতি-কলে-নতুন-অবজেক্ট {raws-ডেল্টা=২} + পরিবার-গেট + জীবন্ত-সিঙ্ক-অন {চিপ-৯·৯·৯-বাংলা-গণনা} + ইতিহাস-বীজ+পুনঃসিঙ্ক + fmt-sync-চতুর্থ-সিঙ্ক {মোড-নিরপেক্ষ-চিপ} + all-রপ্তাই-কপি {ক্লিপবোর্ড-ক্যাপ-সমতা + রেকর্ড-বিহীন} + জীবন্ত-সিঙ্ক-অফ {সর্ব-পরিবার-বার-অপসারণ} + মোবাইল-চিপ-কম্প্যাক্ট {max-width 116px} + পরিষ্কারণ-চুক্তি + কনসোল-শূন্য})। **রিগ্রেশন সর্ব-গ্রিন (১৩-সুইট — ৫৯৬-পাস-শূন্য-ব্যর্থতা):** s330 ৫৫ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + guard:design + audit:views (১২৩ ejs)। সুইট-বিবর্তন-অনুপস্থিত (গণনা-স্থায়িত্ব — চিপ-কাউন্টার-নীরব-নকশা-প্রমাণ)।
- **গোটচা ×৩ (নতুন — PLANS-ডক-কৃত):** ① **বার-অপসারণ-পথ-টিপ-বিপদ** — ensureAll344-এ s344=বার-স্প্যান-নিজে (s342-র s342b=বাটন-ভিন্ন) — parentNode-removeChild(parentNode)-রীতিতে **সম্পূর্ণ-টিপ-DOM-বিচ্ছিন্ন** → tip317.removeChild(s344)-সংশোধন (সিঙ্ক-অফ-পথে টিপ-সংরক্ষণ — কোড-চুক্তি-সংশোধন) ② **চিপ-কাউন্টার-দূষণ** — syncChip344-প্রাথমিক-নকশা getHints('all')-পাঠ-ভিত্তিক → প্রতি-সিঙ্কে q338h.gets+১ {s338-পরম-assert-ভাঙা} + q342h.getmb/last-ওভাররাইট {s342-LSY sync:on-ভাঙা} → **registry-উৎস-প্রত্যক্ষ-গণনায়-নকশা-সংশোধন** (কাউন্টার-নীরব — পুরাতন-সুইট-শূন্য-স্পর্শ) ③ **built-মার্কার-চূড়ান্ততা** — syncChip344-এর 'chip:sync' নির্মাণ-পথের 'sync:on'-ওভাররাইট করে → built344-পতাকায় নির্মাণ-পরে last='sync:on'-পুনঃপ্রয়োগ (s342-সম-মার্কার-অর্থবিদ্যা)। উত্তরাধিকার-গোটচা ×৮-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা।
- **প্যাচ/ডক:** scripts/s344-patch.py (idempotent ×২ — JS+CSS ইনলাইন — অ্যাঙ্কর-এককতা + পোস্ট-অ্যাসার্ট + হেক্স-শূন্য + ক্যাসকেড) + s344-docs.py (এ-ফাইল-ত্রয়ী); PLANS session344-নোটে session345-প্রস্তাব ×৪।

## Task 182 — session345: hr345 ওভারলে-সারি-কীবোর্ড-নেভিগেশন (↑/↓/Home/End — সারি-ফোকাস-যাত্রা) + sfs345 সবুজ-কার্সর-টোন (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609251949`); রাউন্ড-আরম্ভে HEAD=origin=`9654d4f` (session344), clean-tree, BEHIND=০/AHEAD=০; agent-browser-QA বেসলাইন সবুজ (local home-200 {লেখক ফোরাম টাইটেল} + epaper-200 + admin-গেট 302→/admin/login + s344-সুইট ৩১/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ {টানা-১৯-রাউন্ড} + epaper-200 + প্রোড-অ্যাডমিন-৩০৭-cred-gated + hr344/hr343-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = **9654d4f-ডিপ্লয়-প্রমাণ READY** {dpl_2esG/dpl_61ZM ×২-নোট} — PLANS session344-নোটের প্রস্তাব-①-যাচাই-সম্পন্ন)। বাগ-শূন্য-স্থিতিশীল → PLANS session344-নোটের **প্রস্তাব-②-দ্বিতীয়-বিকল্প গ্রহণ** (ওভারলে-সারি-কীবোর্ড-নেভিগেশন — ৯-সারি-যুগে নতুন-মূল্যায়ন-সম্পন্ন-গৃহীত; csv-চতুর্থ-মোড = অপ্রয়োগিত {সুইট-বিবর্তন-ব্যয়-উচ্চ}; all-হিন্ট-সারি-সংযোজন = অপ্রয়োগিত {৯→১০-সারি-ব্যয়}; ③-স্থায়ী-স্থগিত; ④-গেটেড)।
- **[Mandatory-ফিচার] hr345 (admin/home-reorder.ejs — শেয়ার্ড-IIFE-অভ্যন্তরে):** **ওভারলে-সারি-কীবোর্ড-নেভিগেশন** — mkLi330-এক-লাইন-সম্প্রসারণ `li330.tabIndex = -1` (প্রোগ্রাম্যাটিক-ফোকাসযোগ্য — নির্মাতা-এক-উৎস — build/rebuild-সম-পথ — ট্যাব-ক্রম-অস্পৃশ্য); গেট = ovOpen330 ∧ টার্গেট-সর্বনিকট .hr330-ov (ওভারলে-অভ্যন্তর-উৎস-কেবল — **.hr-aria-copy-প্রেক্ষাপট = hr320-ইতিহাস-পয়েন্টার-অটুট — দ্বি-নেভ-সংঘর্ষ-শূন্য** — e2e-প্রমাণিত; sfs292-phone-arrow-পথ-সহ সর্ব-পুরাতন-সুইট-শূন্য-স্পর্শ {রিগ্রেশন-সর্ব-গ্রিন-প্রমাণ}); কার্সর-মেশিন (syncNav345-এক-উৎস — রি-রেন্ডার-বিহীন — শ্রেণি-কেবল — ৫ম-MO-নিষিদ্ধ-চুক্তি-অটুট MO=৪): navIdx345 (−১ = কার্সর-শূন্য — নীরব-শূন্য-অবস্থা); ArrowDown = +১ {৮→০-মোড়ক}, ArrowUp = −১ {০→৮-মোড়ক}, Home = ০, End = ৮; কার্সর-শূন্য-প্রবেশ: Down→প্রথম, Up→শেষ; .hr345-cursor-শ্রেণি-সিঙ্ক + সারি-focus() (সত্যিকার-ফোকাস-যাত্রা — activeElement-যাত্রা-e2e-প্রমাণিত); Space-ব্লক (li-উৎস-কেবল — .hr330-x-বাটন-অস্পৃশ্য — blocks-গণনা); মিশ্র-পথ-সমতা (s343-রীতি): সারি-ক্লিক = কার্সর-সেট + ফোকাস (পয়েন্টার-প্রবেশ→কীবোর্ড-ধারাবাহিকতা — click:N-মার্কার — নেভ-গণনা-স্পর্শ-শূন্য); **জীবন্ত-সিঙ্ক ত্রি-মোড়ক**: openOv330-মোড়ক (ooOrig345 — খোলায় কার্সর-রিসেট — নীরব) + closeOv330-মোড়ক (coOrig345 — বন্ধে কার্সর-পরিষ্কার + .hr330-ov-অভ্যন্তর-ফোকাস-ব্লার {hidden-ফোকাস-ফাঁদ-নিবারণ}) + rebuildOv330-মোড়ক (rbOrig345 — tabIndex-মিলিত {mkLi330-এক-উৎস} + কার্সর-পুনঃপ্রয়োগ); চুক্তি: ovRows330-অ্যারে-অস্পৃশ্য (৯-সারি-স্থায়িত্ব); q320-পয়েন্টার/q330h…q344h-কাউন্টার-অস্পৃশ্য {opens/closes-ডেল্টা-e2e-প্রমাণিত}; registry/kbd-লাইন/storage-অস্পৃশ্য {hr345-কী-শূন্য — পরিষ্কারণ-চুক্তি}; s324-স্ট্যাটিক-বেস-লাইন-অস্পৃশ্য; `__hrAria345QA {navs, homes, ends, wraps, blocks, last, idx(), cur(), rows(), err}` — সারি-শূন্যে-ও-সংজ্ঞায়িত; s344…s330-হুক-সহাবস্থান-অটুট।
- **[Mandatory-স্টাইল] sfs345 (ইনলাইন-<style> session345-ব্লক — cascade EOF-session344-পরে — হেক্স-শূন্য rgba-only):** **সবুজ-পরিবার কার্সর-টোন** (rgba(4,120,87)/rgba(5,150,105) — hr330-মূল-সবুজ-সম-পরিবার — ধ্বংসাত্মক-লাল/নীল-রিড/অ্যাম্বার-সর্ব-মোড-পরিবার-বিভাজন-অটুট): .hr345-cursor inset-বার (desk 2px / ≤640px 1.5px-কম্প্যাক্ট — getComputedStyle-e2e-যাচাইকৃত) + .hr330-k-চিপ-বুস্ট + :focus-রিং (rgba(5,150,105,0.6) — প্রোগ্রাম্যাটিক-ফোকাস-দৃশ্যমানতা — tabIndex=-১-সারি) + :focus-visible-রিং (0.75) + prefers-reduced-motion; **নতুন-অবস্থা-টোন-কেবল** — বিদ্যমান-সারি-ডিফল্ট-রূপ-অস্পৃশ্য (sfs343-অবস্থা-শ্রেণি-রীতি); সর্ব-ব্যান্ড; MO=৪-অটুট; style.css = session345/344/343-শূন্য (admin-CSS-চুক্তি-প্রমাণ) + session334 ×২-অটুট।
- **টেস্ট:** নতুন tests/s345-suite.sh **৩৬/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×৮ + SSR ×৩ + hr345-ই২ই ×১৭ {ফোকাস-যাত্রা + মোড়ক-দ্বি-মুখ + Home/End-জাম্প + রি-রেন্ডার-বিহীন-অভিন্নতা {rows[0]===probe} + W-সারি-সহাবস্থান + Space-ব্লক + মিশ্র-পথ-ক্লিক + Escape-ব্লার + পুনঃখোলা-রিসেট + কাউন্টার-সততা} + মোবাইল ×২ + পরিষ্কারণ-চুক্তি + কনসোল-কাউন্টার)। **রিগ্রেশন সর্ব-গ্রিন (১৪-সুইট + ২-গার্ড — শূন্য-ব্যর্থতা):** s330 ৫৫ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + s345 ৩৬ + guard:design + audit:views (১২৩ ejs)। **সুইট-বিবর্তন-অনুপস্থিত** (৯-সারি-স্থায়িত্ব — ovRows330-অস্পৃশ্য-নকশা-প্রমাণ)। **সুইট-উন্নয়ন-গোটচা ×৩ (PLANS-ডক-কৃত):** ① নেস্টেড-JSON.stringify-cur-এনকোডিং {unjj-ব্যাকস্ল্যাশ-বিকৃতি → ফ্ল্যাট-এনকোডিং-রীতি i:k|'null'} ② ওভারলে-নির্মাণ-পূর্বশর্ত {q330h.open-কল-ব্যতীত .hr330-ov-DOM-শূন্য — rows()=০-নীরব} ③ মোড়ক-নেভ-লেজার {৯-সারি-মোড়ক-যাত্রায় wraps/navs-প্রত্যাশা-হিসাব — দ্বি-ArrowUp {০→৮-মোড়ক→৭} = wraps+১/navs+২}।
- **গোটচা-বিহীন-রাউন্ড** (কোড-চুক্তি-সংশোধন-শূন্য — প্রথম-রান-সর্ব-গ্রিন-পরবর্তী-সুইট-সংশোধন-মাত্র); উত্তরাধিকার-গোটচা ×৮-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা। প্যাচ scripts/s345-patch.py (idempotent ×২ — CSS+tabIndex+JS ত্রি-সংযোজন — অ্যাঙ্কর-এককতা ×৩-assert)। ডক-ত্রয়ী: PROJECT §৩৪৫ + PLANS session345-নোট + repo-worklog Task 182 (s345-docs.py idempotent)।

## Task 183 — session346: hr346 ওভারলে-সারি-Enter-সক্রিয়করণ (এক-উৎস-প্রতিনিধি) + sfs346 সক্রিয়করণ-ফ্ল্যাশ (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609252024`); রাউন্ড-আরম্ভে HEAD=origin=`8599a72` (session345), clean-tree, BEHIND=০/AHEAD=০; agent-browser-QA বেসলাইন সবুজ (local home-200 {লেখক ফোরাম টাইটেল} + epaper-200 + admin-গেট 302→/admin/login + s345-সুইট ৩৬/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ {টানা-২০-রাউন্ড} + epaper-200 + প্রোড-অ্যাডমিন-৩০৭-cred-gated + hr345/hr344-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = **8599a72-ডিপ্লয়-প্রমাণ READY** {dpl_FpBx/dpl_7bgc ×২-নোট} — PLANS session345-নোটের প্রস্তাব-①-যাচাই-সম্পন্ন)। বাগ-শূন্য-স্থিতিশীল → PLANS session345-নোটের **প্রস্তাব-②-তৃতীয়-বিকল্প গ্রহণ** (সারি-Enter-সক্রিয়করণ — দ্বি-সক্রিয়করণ-ঝুঁকি-সতর্ক-মূল্যায়ন-সম্পন্ন-গৃহীত: **এক-উৎস-প্রতিনিধি-রীতিতে-নির্মাণ** — synthetic-KeyboardEvent-প্রেরণ, অনুলিপি-লজিক-শূন্য; csv-চতুর্থ-মোড = অপ্রয়োগিত {সুইট-বিবর্তন-ব্যয়-উচ্চ}; all-হিন্ট-সারি = অপ্রয়োগিত {৯→১০-সারি-ব্যয়}; ③-স্থায়ী-স্থগিত; ④-গেটেড)।
- **[Mandatory-ফিচার] hr346 (admin/home-reorder.ejs — শেয়ার্ড-IIFE-অভ্যন্তরে):** **ওভারলে-সারি-Enter-সক্রিয়করণ — এক-উৎস-প্রতিনিধি** — গেট: ovOpen330 ∧ টার্গেট-সর্বনিকট .hr330-li (.hr330-ov-অভ্যন্তর) ∧ key==='Enter' ∧ মডিফায়ার-বর্জন — .hr330-x-বাটন-নেটিভ-সক্রিয়করণ-অস্পৃশ্য {হাইজ্যাক-শূন্য-ই২ই-প্রমাণিত}; কার্সর-মেশিন-স্বাধীন {q345h-নেভ-গণনা-স্পর্শ-শূন্য-ই২ই-প্রমাণিত}; **প্রতিনিধি**: সারি-কী (.hr330-k-textContent) = সংশ্লিষ্ট-শর্টকাট-কী — প্রথম .hr-aria-copy-উপরে synthetic-KeyboardEvent-প্রেরণ {bubbles+cancelable — মডিফায়ার-শূন্য} → সর্ব-শর্টকাট-হ্যান্ডলার (s324-E/D + s325-X + s326-F + s327-P + s328-C + s329-S + hr343-W + hr330-'?')-নিজস্ব-গেটে-সিদ্ধান্ত {.hr-aria-copy-প্রেক্ষাপট × hist≥১ × W-arm-দ্বি-চাপ × X-পয়েন্টার × '?'-টগল} — অনুলিপি-লজিক-শূন্য; নীরব-নো-অপ-ও-প্রতিনিধি-গণিত {acts = প্রেরণ-গণনা — হ্যান্ডলার-সিদ্ধান্ত-স্বাধীন — X-নীরব-নো-অপ-ই২ই-প্রমাণিত}; **দ্বি-সক্রিয়করণ-ঝুঁকি-নিষ্ক্রিয়করণ (ত্রি-স্তর)**: ① প্রতিনিধি-কী ≠'Enter' → hr346-পুনঃপ্রবেশ-শূন্য ② li = অ-বাটন-উপাদান → নেটিভ-Enter-সক্রিয়করণ-শূন্য ③ hr320-Enter-রিকপি = 'Enter'-কী-কেবল → অস্পৃশ্য; **ব্লক-পথ**: .hr-aria-copy-অনুপস্থিতি {টিপ-বন্ধ = শর্টকাট-প্রেক্ষাপট-শূন্য} → preventDefault + blocked-গণনা {act:notip — ই২ই-প্রমাণিত}; li-বহি-টার্গেট = নীরব-উপেক্ষা {গণনা-শূন্য — সক্রিয়করণ-প্রচেষ্টা-নয়-অর্থবিদ্যা}; **ফ্ল্যাশ**: .hr346-act-শ্রেণি ১.২s-স্বয়ং-নিরামড {hr324-ফ্ল্যাশ-রীতি — ই২ই-on/off-প্রমাণিত}; ফোকাস-স্থির {dispatchEvent-ফোকাস-স্থানান্তর-শূন্য}; চুক্তি: ovRows330-অ্যারে-অস্পৃশ্য (৯-সারি); q320/…/q345h-কাউন্টার-অস্পৃশ্য {opens/closes/navs-ডেল্টা-ই২ই-প্রমাণিত}; storage-অস্পৃশ্য {hr346-কী-শূন্য}; `__hrAria346QA {acts, blocked, last, err}` — সারি-শূন্যে-ও-সংজ্ঞায়িত; s345…s330-হুক-সহাবস্থান-অটুট।
- **[Mandatory-স্টাইল] sfs346 (ইনলাইন-<style> session346-ব্লক — cascade EOF-session345-পরে — হেক্স-শূন্য rgba-only):** **সবুজ-পরিবার-গভীর-টোন = সক্রিয়করণ-সম্পন্ন-সংকেত** (rgba(16,185,129)/rgba(5,150,105) — hr345-কার্সর-সম-পরিবার — নেভ→সক্রিয়-ধারাবাহিকতা — ধ্বংসাত্মক-লাল/নীল-রিড/অ্যাম্বার-সর্ব-মোড-পরিবার-বিভাজন-অটুট): .hr346-act-ফ্ল্যাশ-bg + .hr330-k-চিপ-গভীর-বুস্ট + inset-বার (desk 2px / ≤640px 1.5px-কম্প্যাক্ট — getComputedStyle-e2e-যাচাইকৃত) + prefers-reduced-motion; **নতুন-অবস্থা-টোন-কেবল** — বিদ্যমান-সারি-ডিফল্ট-রূপ-অস্পৃশ্য (sfs345-অবস্থা-শ্রেণি-রীতি); .hr345-cursor-সহাবস্থান {সম-সারি-দ্বি-অবস্থা-শ্রেণি}; সর্ব-ব্যান্ড; MO=৪-অটুট; style.css = session346/345/344-শূন্য (admin-CSS-চুক্তি-প্রমাণ) + session334 ×২-অটুট।
- **টেস্ট:** নতুন tests/s346-suite.sh **৩৩/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×৮ + SSR ×৩ + hr346-ই২ই ×১৫ {li-বহি-নীরব + টিপ-বন্ধ-ব্লক + E-প্রতিনিধি {ক্লিপবোর্ড-ক্যাপ ≡ strip324 + রেকর্ড-বিহীন} + ফ্ল্যাশ-নিরামড + F-প্রতিনিধি {rich→key + চিপ-মোড-নিরপেক্ষ + hr341-fmt-sync} + X-নীরব-নো-অপ {পয়েন্টার-শূন্যে নীরব — হ্যান্ডলার-সিদ্ধান্ত-স্বাধীন} + W-দ্বি-চাপ {আর্ম→ওয়াইপ — hr343-এক-উৎস-parity} + '?'-টগল-বন্ধ {coOrig345-পরিষ্কারণ} + x-হাইজ্যাক-শূন্য + কাউন্টার-সততা {opens/closes/navs/homes/ends/wraps/acts/blocked-সম্পূর্ণ-লেজার}} + মোবাইল ×২ + পরিষ্কারণ-চুক্তি + কনসোল-কাউন্টার)। **রিগ্রেশন সর্ব-গ্রিন (১৫-সুইট + ২-গার্ড — শূন্য-ব্যর্থতা):** s330 ৫৫ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + s345 ৩৬ + s346 ৩৩ + guard:design + audit:views (১২৩ ejs)। **সুইট-বিবর্তন-অনুপস্থিত** (৯-সারি-স্থায়িত্ব)।
- **গোটচা ×১ (কোড-চুক্তি-সংশোধন — PLANS-ডক-কৃত):** **dispatchEvent-সিঙ্ক্রোনাস-পার্শ্বপ্রভাব** — '?'-সারি-Enter-প্রতিনিধি → hr330-টগল-বন্ধ → coOrig345-রিসেট {navIdx345=-১} → last-মার্কার-পোস্ট-রিসেট-পাঠ {act:?@-১ — প্রথম-রানে-ধরা} → **idx-প্রি-ক্যাপচুর-সংশোধন** {idxAt346 = navIdx345 — dispatch-পূর্বে}। **সুইট-উন্নয়ন-গোটচা ×২:** ① jf-হেল্পার-None-অর্থবিদ্যা {JSON-null → python-'None'-প্রিন্ট — 'null'-তুলনা-ব্যর্থ → null-নিরাপদ-ইনলাইন-পার্সিং-রীতি (s345-CURF-সম)} ② rld-গণনা-পুনঃআরম্ভ {ইন-মেমরি-QA-হুক-কাউন্টার রিলোডে-শূন্য — মোবাইল-ধাপে পোস্ট-রিলোড-প্রত্যাশা-লেজার}। উত্তরাধিকার-গোটচা ×৮-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা। প্যাচ scripts/s346-patch.py (idempotent ×২ — CSS+JS দ্বি-সংযোজন — অ্যাঙ্কর-এককতা ×২-assert)। ডক-ত্রয়ী: PROJECT §৩৪৬ + PLANS session346-নোট + repo-worklog Task 183 (s346-docs.py idempotent)।

## Task 184 — session347: hr347 D/S-সারি-Enter-সক্রিয়করণ I/O-লেজার + sfs347 সায়ান-I/O-ফ্ল্যাশ-ভ্যারিয়েন্ট (২৫ সেপ্টেম্বর ২০২৬)

- **রাউন্ড-আরম্ভ:** cron 403679-এর ট্রিগার (09-25 20:49:35, trace `…202609252051`)। সন্ধান: HEAD=origin=`9232ab4` (session346), clean-tree, BEHIND=০। agent-browser-QA বেসলাইন সবুজ (local home-200 + epaper-200 + admin-গেট 302 + s346-সুইট ৩৩/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ + epaper-200 + প্রোড-অ্যাডমিন-৩০৭-cred-gated — hr346-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = **9232ab4-ডিপ্লয়-প্রমাণ READY**) — PLANS session346-নোটের প্রস্তাব-①-যাচাই-সম্পন্ন।
- **বাগ-শূন্য-স্থিতিশীল** → PLANS session346-নোটের **প্রস্তাব-②-তৃতীয়-বিকল্প গ্রহণ**: hr347 (admin/home-reorder.ejs — শেয়ার্ড-IIFE-অভ্যন্তরে-সম্প্রসারণ — সহাবস্থান-রীতি): D/S-সারি-Enter-সক্রিয়করণ I/O-লেজার — এক-উৎস-সংযোগ q346h.last-মার্কার-পাঠ-কেবল {'act:D@N'/'act:S@N' — ^act:(D|S)@-regex}; শ্রোতা-নিবন্ধন-ক্রম-নিশ্চয়তা {hr346-পরে-নিবন্ধিত — DOM-ক্রম}; synthetic-'D'/'S' = key!=='Enter'-ফিল্টার — পুনঃপ্রবেশ-শূন্য; নয়েজ-ফিল্টার-গেট {key==='Enter' ∧ মডিফায়ার-বর্জন ∧ ovOpen330 ∧ li-অভ্যন্তর ∧ q346h.last-মিল — li-বহি-Enter-এ পুরাতন-মার্কার-দূষণ-শূন্য}; লেজার = সম্পন্ন-কেবল {D → dlHist324-সম-গেট hist≥১ → dl+bytesD = new Blob([strip324()]).size — এক-উৎস-payload-আকার-পাঠ-কেবল — **dlHist324-ব্লব-পথ-assert-চ্যালেঞ্জ-সমাধান**; S → dlPv329-সম-গেট → sv+bytesS; শূন্য-ইতিহাস = 'io:D@skip'/'io:S@skip' — লেজার-বহি + ফ্ল্যাশ-বহি}; I/O-ফ্ল্যাশ-ভ্যারিয়েন্ট .hr347-io ১.২s-স্বয়ং-নিরামড {hr346-ফ্ল্যাশ-সহাবস্থান}; চুক্তি: ovRows330/q-কাউন্টার/storage-অস্পৃশ্য {q346h.last-পাঠ-কেবল — লেখা-শূন্য}; ক্লিপবোর্ড-স্পর্শ-শূন্য; `__hrAria347QA {dl, sv, bytesD, bytesS, last, err}` — সারি-শূন্যে-ও-সংজ্ঞায়িত।
- **[Mandatory-স্টাইল] sfs347:** session347-ইনলাইন-ব্লক (EOF-session346-পরে — হেক্স-শূন্য rgba-only): সায়ান-পরিবার = ফাইল-I/O-সম্পন্ন-সংকেত {rgba(8,145,178)/rgba(14,116,144) — নতুন-পরিবার-বিভাজন} + **কম্পাউন্ড-ক্যাসকেড .hr347-io.hr346-act** {সায়ান-জয় — দ্বি-শ্রেণি-প্রাধিকার্য} + .hr330-k-সায়ান-বুস্ট + inset {desk 2px / ≤640px 1.5px} + reduced-motion + নতুন-অবস্থা-টোন-কেবল + style.css = session347-শূন্য {334 ×২-অটুট}।
- **টেস্ট:** নতুন tests/s347-suite.sh **৩২/০/০ ×২-ধারাবাহিক (SKIP=০)** (পরিবেশ ×৩ + কাঠামো ×৮ + SSR ×৩ + ই২ই ×১৩ — হুক-সহাবস্থান + skip-পথ + নয়েজ-ফিল্টার + ইতিহাস-বীজ + D-লেজার-ব্লব-ক্রস-ভ্যালিডেশন {bytesD ≡ URL.createObjectURL-স্টাব-আকার — দ্বি-পর্যবেক্ষক ১৭৭≡১৭৭} + দ্বি-ফ্ল্যাশ-নিরামড + S-লেজার-ফাইলনাম-প্রমাণ + E-লেজার-বহি + নেটিভ-'d'-পথ-লেজার-বহি + কাউন্টার-সততা {acts=৪/blocked=০} + ডেস্ক-কম্পাউন্ড-ক্যাসকেড + মোবাইল ×২ + পরিষ্কারণ + কনসোল-শূন্য) + **পূর্ণ-রিগ্রেশন s330-s347 (১৬-সুইট ৬৬২-পাস-শূন্য-ব্যর্থতা; ছোট-চাঙ্ক ৪×৪ + ডেমন-হেলথ-প্রোব)** + guard:design + audit:views (১২৩ ejs)
- **গোটচা ×২ (PLANS session347):** ① skip-পথ-প্রি-প্রয়োজনীয়তা {টিপ-বন্ধে D-Enter = hr346-ব্লক-পথ act:notip — লেজার-পথ-নয় → opentip-প্রথম} ② async-copies-ডেল্টা-পাঠ {ক্লিপবোর্ড-promise-মাইক্রোটাস্ক — ≥৪৫০ms-wait-পরবর্তী-পাঠ}
- **পাইপলাইন:** প্যাচ scripts/s347-patch.py (idempotent ×২, মার্কার-গার্ড-প্রথম, নেমস্পেস-গার্ড ×৫, অ্যাঙ্কর-এককতা-FATAL ×২, ইউনিক-লাইন-পোস্ট-অ্যাসার্ট ×৫ + হেক্স-শূন্য + ক্যাসকেড-অবস্থান + node --check) + feature-commit + ডক ×৩ (s347-docs.py idempotent ×২) + docs-commit + secret-scan-ক্লিন + fetch (**BEHIND-যাচাই**) → push → Vercel webhook-ডিপ্লয়-যাচাই → প্রোড-স্পট

## Task 185 — session348: hr348 ওভারলে-সারি-aria-keyshortcuts (ত্রি-উৎস-এক-সত্য) + sfs348 ফায়ান্সি-আবিষ্কার-টোন + P/C-Enter-প্রতিনিধি-ই২ই-যাচাই (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609252135`); রাউন্ড-আরম্ভে HEAD=origin=`fb9f626` (session347-ডক), clean-tree, BEHIND=০; agent-browser-QA বেসলাইন সবুজ (local home/epaper-200 + admin-গেট 302 + s347-সুইট ৩২/০/০) + **প্রোড-স্পট** (vercel home/epaper-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ {টানা-২২-রাউন্ড} + প্রোড-অ্যাডমিন-৩০৭-cred-gated + hr347/sfs347-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = fb9f626-যুগ-প্রোড-স্বাস্থ্য-প্রমাণ)। বাগ-শূন্য-স্থিতিশীল → PLANS session347-নোটের **প্রস্তাব-②-দ্বিতীয়-বিকল্প গ্রহণ** (ওভারলে-সারি-aria-keyshortcuts) + প্রথম-বিকল্পের-যাচাইযোগ্য-অংশ-সহ (P/C-Enter-প্রতিনিধি-ই২ই — সুইট-কেবল); ③-স্থায়ী-স্থগিত; ④-গেটেড।
- **[Mandatory-ফিচার] hr348 (admin/home-reorder.ejs):** mkLi330-এক-লাইন-সম্প্রসারণ — li.setAttribute('aria-keyshortcuts', row330m[0]) — **ত্রি-উৎস-এক-সত্য** {row330m[0] = .hr330-k-textContent = hr346-প্রতিনিধি-সম-কী}; নির্মাতা-এক-উৎস → build/rebuild-সম-পথ-স্বয়ং-কভারড; স্ক্রিন-রিডার-সক্রিয়করণ-পরিচিতি (li-ফোকাসযোগ্য hr345-tabIndex=-১); ovRows330-অ্যারে-অস্পৃশ্য (৯-সারি); পাঠযোগ্য-attr-কেবল (q-কাউন্টার/storage/লেজার-স্পর্শ-শূন্য); __hrAria348QA {aks(), aksK(), last, err} — নির্মাণ-পূর্ব aks()=[]; **+P/C-Enter-ই২ই-যাচাই** (P → togglePv327 opens/closes + aria-expanded; C → copyPv328 প্রথমে-খোলা + ক্লিপবোর্ড ≡ last ≡ প্রিভিউ; P/C = hr347-লেজার-বহি)।
- **[Mandatory-স্টাইল] sfs348:** home-reorder.ejs ইনলাইন-<style> session348-ব্লক (কেবল-সংযোজন — হেক্স-শূন্য rgba-only — cascade EOF-session347-পরে) — ফায়ান্সি-পরিবার = শর্টকাট-আবিষ্কার-সংকেত (rgba(162,28,175)/rgba(192,38,211)/rgba(134,25,143) — নতুন-পরিবার-বিভাজন); hover/focus-কীক্যাপ-বুস্ট {inset-ছায়া desk 1.5px / ≤640px 1px}; **:not-গার্ড-চতুষ্টয়** {[data-hr343-w]/.hr345-cursor/.hr346-act/.hr347-io — অবস্থা-টোন-অজেয়}; কেবল-চিপ-টোন; সর্ব-ব্যান্ড; MO=৪-অটুট; style.css = session348/347-শূন্য + session334 ×২-অটুট।
- **টেস্ট:** নতুন tests/s348-suite.sh **৩২/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×৮ + SSR ×৩ + hr348-ই২ই ×১৩ — aria-keyshortcuts ×৯-সম-ক্রম + attr≡চিপ ৯/৯ + aksK-স্পট + P-টগল-দ্বি-মুখ + C-প্রথমে-খোলা-কপি-ত্রি-সমতা + P/C-লেজার-বহি + লেজার-চুক্তি opens=২/closes=১/copies=১ + ফায়ান্সি-টোন + অবস্থা-প্রাধিকার্য + মোবাইল ×২ + পরিষ্কারণ + কনসোল-শূন্য)। রিগ্রেশন সর্ব-গ্রিন (১৭-সুইট — ৬৯৪-পাস): s330 ৫৫ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + s345 ৩৬ + s346 ৩৩ + s347 ৩২ + s348 ৩২ + guard:design + audit:views (১২৩ ejs)। সুইট-বিবর্তন-অনুপস্থিত।
- **গোটচা ×৩ (সুইট-উন্নয়ন):** ① grep-লাইন-বনাম-অসংঘটন {doc-কমেন্টে-সম-স্ট্রিং — grep -o|wc -l-রীতি} ② ev-অ্যারে-আউটপুট-উদ্ধৃত-আবৃত {সর্বজনীন-unjj-মোড়ক-রীতি} ③ স্টাব-জীবনকাল-rld-সীমা {defineProperty-স্টাব রিলোডে-নীল — rld-পরবর্তী-পুনঃস্টাব — hist-বীজ-শূন্য-মিথ্যা-ফেল-প্রতিরোধ — seedhist-অভ্যন্তরীণ-যাচাই-দ্বি-প্রচেষ্টা}; উত্তরাধিকার-গোটচা ×১৩-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা।
- **প্যাচ/ডক:** scripts/s348-patch.py (idempotent ×২ — mkLi-এক-লাইন + CSS+JS দ্বি-সংযোজন — অ্যাঙ্কর-এককতা ×৩-assert — ইউনিক-লাইন-পোস্ট-অ্যাসার্ট ×৬ + হেক্স-শূন্য + ক্যাসকেড-অবস্থান) + s348-docs.py (এ-ফাইল-ত্রয়ী); PLANS session348-নোটে session349-প্রস্তাব ×৪ (প্রোড-স্পট + csv-চতুর্থ-মোড/aria-describedby-জুটি/X-নীরব-যাচাই + গাটার-গবেষণা + bot-সিঙ্ক-গেটেড)।

## Task 186 — session349: hr349 ওভারলে-সারি-aria-describedby-জুটি (hintOf334-উদ্ভূত) + sfs349 ইন্দিগো-বর্ণনা-আবিষ্কার-টোন + cf349-জীবন্ত-সিঙ্ক (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609252219`); রাউন্ড-আরম্ভে HEAD=origin=`68df572` (session348-ডক), clean-tree, BEHIND=০; agent-browser-QA বেসলাইন সবুজ (local home-200 + admin-গেট 302 + s348-সুইট ৩২/০/০) + **প্রোড-স্পট** (vercel home/epaper-200 + session334-মার্কার ×২-লাইভ-/assets/css/style.css-এ {টানা-২৪-রাউন্ড} + প্রোড-অ্যাডমিন-৩০৭-cred-gated + session348/347-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = 68df572-যুগ-প্রোড-স্বাস্থ্য-প্রমাণ)। বাগ-শূন্য-স্থিতিশীল → PLANS session348-নোটের **প্রস্তাব-②-দ্বিতীয়-বিকল্প গ্রহণ** (ওভারলে-সারি-aria-describedby-সংযোগ); ③-স্থায়ী-স্থগিত; ④-গেটেড।
- **[Mandatory-ফিচার] hr349 (admin/home-reorder.ejs):** mkLi330-দ্বি-লাইন-সম্প্রসারণ — ① .hr349-d-উৎস-span {hintOf334-কল-টাইম-রেজলভ — {fmt}-মোড-সচেতন — id = 'hr349-d-'+সারি-কী} + ② li.setAttribute('aria-describedby', d349.id) — **hr348-কী-attr-জুটি-সম্পূর্ণতা** {কী-ঘোষণা + কর্ম-ঘোষণা}; নির্মাতা-এক-উৎস → build/rebuild-সম-পথ {rebuild = firstChild-পরিষ্কারণ-পূর্ব-নির্মাণ — ডুপ-আইডি-শূন্য}; **জীবন্ত-সিঙ্ক-ত্রি-পথ** {cf349-চক্র-পরবর্তী syncDs349() + register→rebuild-স্বয়ং-সতেজ + setHint-স্ন্যাপশট-চুক্তি {sync()-উপলব্ধ}}; ovRows330-অ্যারে-অস্পৃশ্য (৯-সারি); q-কাউন্টার/storage/ক্লিপবোর্ড-অস্পৃশ্য; appendHint334-পাঠ-কেবল; __hrAria349QA {ds(), dsK(), dsT(), sync(), last, err} — নির্মাণ-পূর্ব ds()=[]; s348…s330-হুক-সহাবস্থান-অটুট।
- **[Mandatory-স্টাইল] sfs349:** home-reorder.ejs ইনলাইন-<style> session349-ব্লক (কেবল-সংযোজন — হেক্স-শূন্য rgba-only — cascade EOF-session348-পরে) — ইন্দিগো-পরিবার = বর্ণনা/হিন্ট-ঘোষণা-সংকেত (rgba(67,56,202)/rgba(79,70,229) — নতুন-পরিবার-বিভাজন — ফায়ান্সি-পরে); **.hr349-d-দৃষ্টিহীন-রীতি** {SR-only — absolute+1px+inset(50%)}; hover/focus → .hr330-d-বর্ণনা-টোন {ইন্দিগো + আন্ডারলাইন + offset desk 2px / ≤640px 1px}; **অর্থোগোনাল-ক্ষেত্র-নকশা** {.hr330-d = সর্ব-অবস্থা-পরিবার-অস্পৃশ্য → :not-গার্ড-অপ্রয়োজনীয় — সর্ব-অবস্থা-সম-আচরণ — অবস্থা-টোন-অজেয়-অটুট}; সর্ব-ব্যান্ড; style.css = session349/348/347-শূন্য + session334 ×২-অটুট। **s348-লক-সচেতনতা:** নতুন-লাইনে 'aria-keyshortcuts'/':not([data-hr343-w])'-লিটারাল-শূন্য {সুইট-লক-দ্বয়-অটুট-প্রমাণ}।
- **টেস্ট:** নতুন tests/s349-suite.sh **৩৪/০/০ ×২-ধারাবাহিক** (পরিবেশ ×৩ + কাঠামো ×৯ + SSR ×৩ + hr349-ই২ই ×১৪ — aria-describedby ×৯-সম-ক্রম + attr≡span ৯/৯ + dsT/dsK-স্পট + F-{fmt}-সমতা + দৃষ্টিহীন-মেট্রিক্স + sync()=৯ + cf349-জীবন্ত-সিঙ্ক {t0≠t1 + ≡ hintOf334 + appends/opens-ডেল্টা=০} + ইন্দিগো-টোন + অর্থোগোনাল-সহাবস্থান {W-লাল/কার্সর-সবুজ-কীক্যাপ-অটুট} + মোবাইল ×২ + পরিষ্কারণ + কনসোল-শূন্য)। রিগ্রেশন সর্ব-গ্রিন (২০-সুইট — ৮৪৪-পাস): s330 ৫৫ + s331 ৫৮ + s332 ৫৮ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + s345 ৩৬ + s346 ৩৩ + s347 ৩২ + s348 ৩২ + s349 ৩৪ + guard:design + audit:views (১২৩ ejs)। সুইট-বিবর্তন-অনুপস্থিত।
- **গোটচা ×৩ (সুইট-উন্নয়ন):** ① গেটেড-বার-নির্মাণ {.hr324-bar/.hr326-fmt = hist≥১-গেটেড — শূন্য-ইতিহাসে fmt-বাটন-অনুপস্থিত → নীরব-স্কিপ → t1==t0-মিথ্যা-ফেল — seedhist-পূর্ব-বাধ্যতামূলক} ② মোড়ক-পাঠ-টাইমিং {এক-ইভ্যালে-click+পাঠ = পোস্ট-চক্র-মান — ত্রি-ইভ্যাল-বিভাজন + ডেল্টা-ব্যাশ-গণনা} ③ স্থায়ী-মোড-রাজ্য {hr326-fmt-storage-রান-ভেদে-টিকে — মোড-অজ্ঞেয়-assert-রীতি}; উত্তরাধিকার-গোটচা ×১৬-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা।
- **প্যাচ/ডক:** scripts/s349-patch.py (idempotent ×২ — mkLi-দ্বি-লাইন + CSS+JS দ্বি-সংযোজন — অ্যাঙ্কর-এককতা ×৩-assert — ইউনিক-লাইন-পোস্ট-অ্যাসার্ট ×১৮ + হেক্স-শূন্য + s348-লক-দ্বয়-assert) + s349-docs.py (এ-ফাইল-ত্রয়ী); PLANS session349-নোটে session350-প্রস্তাব ×৪ (প্রোড-স্পট + setHint-লাইভ-সিঙ্ক/csv-চতুর্থ-মোড/X-নীরব-যাচাই + গাটার-গবেষণা + bot-সিঙ্ক-গেটেড)।

## Task 187 — session350: hr350 হিন্ট-সম্পাদনা-পথ-বর্ণনা-লাইভ-সিঙ্ক (মোড়ক-চেইন) + sfs350 গোলাপি-সিঙ্ক-ফ্ল্যাশ (২৫ সেপ্টেম্বর ২০২৬)
- **রাউন্ড:** cron 403679 (trace `…202609252304`); রাউন্ড-আরম্ভে HEAD=origin=`2d7e1fb` (session349-ডক), clean-tree, BEHIND=০; agent-browser-QA বেসলাইন সবুজ (local home-200 + admin-গেট 302 + s349-সুইট ৩৪/০/০) + **প্রোড-স্পট** (vercel home-200 + session334-মার্কার ×২-লাইভ {টানা-২৬-রাউন্ড} + প্রোড-অ্যাডমিন-৩০৭-cred-gated + session349/348-মার্কার-পাবলিক-পাঠে-শূন্য-ই-প্রত্যাশিত = 2d7e1fb-যুগ-প্রোড-স্বাস্থ্য-প্রমাণ)। বাগ-শূন্য-স্থিতিশীল → PLANS session349-নোটের **প্রস্তাব-②-প্রথম-বিকল্প গ্রহণ** (setHint-পথ-লাইভ-সিঙ্ক); ③-স্থায়ী-স্থগিত; ④-গেটেড।
- **[Mandatory-ফিচার] hr350 (admin/home-reorder.ejs):** setHint/setHints-মোড়ক-চেইন {s337-গেট-রীতি — শেষ-মান-ক্যাপচার} — সফল-সেটে syncDs350() {পরিবর্তন-সনাক্ত-পুনঃমূল্যায়ন — hintOf334-কল-টাইম} + পরিবর্তিত-সারিতে .hr350-sync-ফ্ল্যাশ {১.২s-স্বয়ং-নিরামড}; ব্যাচ = এক-সিঙ্ক-পাস; **জীবন্ত-সিঙ্ক-চতুর্থ-পথ-সম্পূর্ণ** {চক্র + register + স্ন্যাপশট → মোড়ক-সক্রিয়-সিঙ্ক}; q335h/q336h/q337h-পাসথ্রু-অটুট; cf349/syncDs349-অস্পৃশ্য {চক্র-পথ-নীরব}; q335h.set-লিগ্যাসি-অস্পৃশ্য; __hrAria350QA {syncs, flashes, last, sync(), err}; সুইট-প্রমাণ: setHint-তাৎক্ষণিক-সিঙ্ক {dsT + ফ্ল্যাশ + q335h.sets Δ} + অটো-নিরামড + অপরিবর্তিত-নীরব + F-{fmt} + ব্যাচ-দ্বি-ফ্ল্যাশ + স্থায়ী-রিপ্লে-জোট।
- **[Mandatory-স্টাইল] sfs350:** home-reorder.ejs ইনলাইন-<style> session350-ব্লক (কেবল-সংযোজন — হেক্স-শূন্য rgba-only — cascade EOF-session349-পরে) — গোলাপি-পরিবার = হিন্ট-সম্পাদনা-সিঙ্ক-সংকেত (rgba(225,29,72)/rgba(190,18,60) — নতুন-পরিবার-বিভাজন — ইন্দিগো-পরে); .hr350-sync {li-bg + inset-বার + .hr330-d-গোলাপি + আন্ডারলাইন} — সিঙ্ক-মুহূর্তে-ইন্দিগো-জয় {cascade-পরবর্তী}; W-অর্থোগোনাল {কীক্যাপ-লাল-অটুট + বর্ণনা-গোলাপি — দ্বি-টোন-সংঘর্ষ-শূন্য-ই২ই}; ≤640px offset 1px; সর্ব-ব্যান্ড; style.css = session350-শূন্য + session334 ×২-অটুট। **লক-সচেতনতা:** s348/s349-লক-চতুষ্টয়-অটুট-প্রমাণ {সুইট-assert ×৪}।
- **টেস্ট:** নতুন tests/s350-suite.sh **৩৪/০/০ ×২-ধারাবাহিক** + রিগ্রেশন সর্ব-গ্রিন (২১-সুইট — ৮৭৮-পাস): s330 ৫৫ + s331 ৫৮ + s332 ৫৮ + s333 ৫৪ + s334 ৫৭ + s335 ৪১ + s336 ৪৪ + s337 ৫০ + s338 ৪৭ + s339 ৪৯ + s340 ২৯ + s341 ৩৩ + s342 ৩৬ + s343 ৩৫ + s344 ৩১ + s345 ৩৬ + s346 ৩৩ + s347 ৩২ + s348 ৩২ + s349 ৩৪ + s350 ৩৪ + guard:design + audit:views (১২৩ ejs)। সুইট-বিবর্তন-অনুপস্থিত।
- **গোটচা ×১ (প্যাচ-উন্নয়ন):** ডক-PLANS-রেফ-মার্কার-গণনা {hr349-ডকে 'session348'-রেফ — EJS-ব্যাপী মার্কার-গণনা = ব্যানার + ডক-রেফ — ভবিষ্যৎ-প্যাচে ডক-রেফ-সচেতন-প্রত্যাশা-রীতি}; উত্তরাধিকার-গোটচা ×১৭-অটুট + চাংকড-রিগ্রেশন-রেস-সচেতনতা।
- **প্যাচ/ডক:** scripts/s350-patch.py (idempotent ×২ — CSS+JS দ্বি-সংযোজন — অ্যাঙ্কর-এককতা ×২-assert — ঐতিহাসিক-লক-পোস্ট-অ্যাসার্ট ×১২ + নতুন-টোকেন ×৯) + s350-docs.py (এ-ফাইল-ত্রয়ী); PLANS session350-নোটে session351-প্রস্তাব ×৪ (প্রোড-স্পট + q335h.set-সংযোগ/csv-চতুর্থ-মোড/X-নীরব-যাচাই + গাটার-গবেষণা + bot-সিঙ্ক-গেটেড)।
---
Task ID: keeper-401248 (০২:০০-রাউন্ড)
Agent: Super Z (keeper cron 401248, web-db1dc502, trace 1a0bfd7d601face5)
Task: কিপার-রাউন্ড — নীরব-পর্যবেক্ষণ (পুনঃঅথ-প্রতীক্ষা)

Work Log:
- কিপার: exit 3 — আজকের (2026-09-26) পেপার-নেই (সর্বশেষ 2026-09-23), হার্টবিট 27s সুস্থ; API ok:true ৫-পেপার ক্রস-যাচাই
- bot.log: AUTH_KEY_DUPLICATED (406) GetHistory-ব্যর্থতা অব্যাহত — পূর্ব-রাউন্ডের চিহ্নিত-সংকটই, নতুন-তথ্য-শূন্য
- ইউজার-বার্তায় নতুন-ক্রেডেনশিয়াল-নেই → README-৫-ধাপ-প্রবাহ-শুরু-করা-যায়নি; নীরব-নোট-নীতি (স্প্যাম-নয়)

Stage Summary:
- সব-পূর্ববর্তী-অবস্থার-অনুরূপ; বট-প্রসেস-রেখে-দেওয়া (রিস্টার্ট-অর্থহীন-প্রমাণিত); ইউজার-পুনঃঅথ-ই-একমাত্র-পথ; পরের-রাউন্ডে-ও-একই-নীতি
---
Task ID: reauth-20260926 (ইউজার-সরাসরি-অনুরোধ, ১৬:০৫-১৬:৩০ +06)
Agent: Super Z (web-db1dc502)
Task: AUTH_KEY_DUPLICATED-সংকটের সমাধান — ইউজার-পুনঃঅথ-প্রবাহ + ব্যাকফিল + ভল্ট-সেভ

Work Log:
- ইউজার-প্রশ্নের-উত্তরে RCA-ব্যাখ্যা; প্রবাহ-শুরু: bun src/login-send.ts (README-র `bun run login-send` স্ক্রিপ্ট-নাম package.json-এ নেই — সরাসরি-ফাইল-রান; ভবিষ্যৎ-নোট) → OTP Telegram-অ্যাপে
- ইউজার OTP+2FA → TG_OTP/TG_2FA-সহ login-verify.ts → ✅ নতুন-সেশন .tg-session (৩৬৯-বাইট)
- গুরুত্বপূর্ণ-আবিষ্কার: index.ts-এ TG_SESSION-env-প্রাধিকার (.tg-session-ফাইল-ফলব্যাক) — .env-এর মৃত-সেশন python3-re.sub দিয়ে নতুন-মানে রিপ্লেস
- test-drive ✅ (ড্রাইভ-টোকেন-জীবিত; টেস্ট-আপলোড সফল)
- বট-রিস্টার্ট: pkill-প্যাটার্ন-ব্যর্থ (cmdline "bun run src/index.ts") → kill-by-PID (1600) → ensure-bot.sh → নতুন-PID 27306, লাইভ-লিসেনার-সক্রিয়
- ব্যাকফিল-স্বয়ংক্রিয় (BACKFILL_DAYS=3): মোট ১৪-পেপার সিঙ্ক — ২৫-সেপ্টেম্বর ×৬ (প্রথম আলো#92, TOB#93, যুগান্তর#94, অবজারভার#95, TBS#96, স্টার#97) + ২৬-সেপ্টেম্বর ×৮+ (জাতীয় অর্থনীতি#98, ইত্তেফাক#99, দেশ রূপান্তর#100, কালের কণ্ঠ#101 …); ২৪-সেপ্টেম্বর-পেপার চ্যানেলেই-নেই (পোস্ট-ই-হয়নি)
- লাইভ-যাচাই: /api/epaper/papers count 5→7 — ফিচার্ড ২৬-সেপ্টেম্বর TBS + ২৫-সেপ্টেম্বর স্টার; /archive-এ ২৬-এ ×১১ + ২৫-এ ×৫+
- **ভল্ট-সেভ (ম্যান্ডেটরি-ধাপ)**: GITHUB_TOKEN-সহ save-env-to-gist.sh → ✅ split-encoded, raw-প্যাটার্ন-শূন্য, স্ক্যানার-প্রুফ (gist 010a2b3b…)

Stage Summary:
- সংকট-সম্পূর্ণ-নির্মূল: বট-পুনরায়-স্বয়ংক্রিয়, আজকের-পেপার-লাইভ, ৩-দিনের-ফাঁক-পূরণ (২৪-বাদে); নতুন-ক্রেডেনশিয়াল ভল্টে-নিরাপদ; পরের-কিপার-রাউন্ড exit-0 প্রত্যাশিত
- শিক্ষা: (১) সেশন-রিনিউ-হলে .env-TG_SESSION-আপডেট-আবশ্যক (ফাইল-কেবল-ফলব্যাক); (২) pkill-এর-বদলে kill-by-PID নির্ভরযোগ্য
---
Task ID: reauth-401248 (১৬:২০-রাউন্ড — **সংকট-নিরসন: পুনঃঅথ-সফল**)
Agent: Super Z (keeper cron 401248, web-db1dc502, trace 1a0dd327e7acbb61/1a0bfd7d601face5)
Task: ইউজার-ক্রেডেনশিয়াল (TG_OTP+TG_2FA) দিয়ে README-৫-ধাপ-পুনঃঅথ + বট-পুনরুজ্জীবন

Work Log:
- ইউজার-বার্তায় TG_OTP+TG_2FA এসেছে → login-send-এর .tg-auth-state.json সহ `bun src/login-verify.ts` (package.json-স্ক্রিপ্ট-বহির্ভূত, সরাসরি-ফাইল-রান) → ✅ লগইন-সফল, .tg-session + .env-এর TG_SESSION-আপডেট
- Google-ধাপ: `bun run test-drive` পাস (আপলোড+পাবলিক-পারমিশন ঠিক) — GOOGLE_REFRESH_TOKEN টিকে-আছে, কনসেন্ট-ধাপ-অপ্রয়োজনীয়
- বট-রিস্টার্ট: পুরনো-প্রসেস (27306, মৃত-সেশন-বাহক) kill → ensure-bot.sh → নতুন-প্রসেস 27772 নতুন-সেশনে
- ব্যাকফিল (BACKFILL_DAYS=3, উইন্ডো 09-24→আজ): **৮× 2026-09-26 পেপার** (আমার দেশ#107, টাইমস#108, বিজনেস স্ট্যান্ডার্ড#109, অবজারভার#110, সমকাল#111, প্রথম আলো#112, ডেইলি স্টার#113, যুগান্তর#114) + 1× 2026-09-25 ডেইলি স্টার → epaper_files-আর্কাইভে সব; featured/papers-API-তে প্রতি-তারিখে-শেষ-সিঙ্ক (26-যুগান্তর, 25-স্টার) — ডিজাইন-অনুযায়ী
- কিপার: **exit 0** — "আজকের পেপার-উপস্থিত", হার্টবিট 19s; AUTH_KEY_DUPLICATED-নতুন-ঘটনা-শূন্য (৪৫৯ = রিস্টার্ট-পূর্ব-ঐতিহাসিক-কাউন্ট)
- **ভল্ট-সেভ**: GITHUB_TOKEN-env-সহ save-env-to-gist.sh → gist 010a2b3bb656ac81f933678c2c8ed99f আপডেট (split-encoded, raw-প্যাটার্ন-শূন্য, স্ক্যানার-প্রুফ-যাচাইকৃত)

Stage Summary:
- ০৯-২২-থেকে-চলা AUTH_KEY_DUPLICATED-সংকট সম্পূর্ণ-নিরসন; বট পুনরায় পূর্ণ-অটোমেটেড; ভল্টে-সেভ-সম্পন্ন — ভবিষ্যৎ-রিসেটে ensure-bot.sh স্বয়ং-রিস্টোর-করবে; ০৯-২৪-পেপার-চ্যানেলে-অনুপস্থিত-ছিল-বলে-সিঙ্ক-হয়নি (উইন্ডো-অন্তর্ভুক্ত-থেকেও-উৎস-নেই)
---
Task ID: keeper-401248 (২২:৪০-রাউন্ড — **স্যান্ডবক্স-রিসেট-পূর্ণ-পুনরুদ্ধার**)
Agent: Super Z (keeper cron 401248, web-db1dc502, trace 1a0bfd7d601face5)
Task: /home/z/lekhok-forum সম্পূর্ণ-মুছে-যাওয়া (exit 127) — গিস্ট-ভল্ট দিয়ে সেলফ-হিলিং

Work Log:
- কিপার exit 127: bot-keeper.sh-ই-অনুপস্থিত → /home/z/lekhok-forum সহ স্যান্ডবক্স-পূর্ণ-রিসেট (মায়-প্রজেক্ট-টেমপ্লেট-ছাড়া-সব-গেছে); লোকাল-ক্রেডেন্সিয়াল-শূন্য (টোকেন-ফাইলে-কখনো-নয়-নীতি → রিসেট-প্রুফ প্রমাণিত)
- ভল্ট-পুনরুদ্ধার: গিস্ট-API রেট-লিমিটেড (403) → অ্যাননিমাস-raw-ফলব্যাক-পথ ব্যবহার: gist.github.com/010a2b3bb656ac81f933678c2c8ed99f HTML-200 → raw 3729-বাইট; owner=rafsancuac আবিষ্কৃত
- স্কিম-যাচাই: split-encoded KEY_P1/KEY_P2 = concat-then-decode (SEARCH_API_KEY-যে P1len%4≠0 → schemeB-অসম্ভব; GOCSPX-/AIza-প্রিফিক্স-প্রমাণ)
- রিপো-ক্লোন: github.com/rafsancuac/lekhok-forum পাবলিক-প্রমাণিত, অ্যাননিমাস-ক্লোন-সফল; HEAD=5a9e393 (reauth-401248), worklog-অক্ষত-ফিেছে
- restore-env-from-gist.sh চালাই: ৭-সিক্রেট-পুনর্গঠিত, .env ২০-কি, প্লেসহোল্ডার-শূন্য (প্রাথমিক-cat-প্রদর্শনে p2[ সিনট্যাক্স-বাগ-মনে-হয়েছিল — Read-যাচাইয়ে স্ক্রিপ্ট-অক্ষত-প্রমাণিত, কোনো-প্যাচ-প্রয়োজন-হয়নি)
- bun install (138-pkg) → ensure-bot.sh → বট-চালু PID 1363
- যাচাই: বট-স্টার্টআপ-ব্যাকফিল ২৬-সেপ্টেম্বর আমার-দেশ#107/টাইমস#108/বণিক-বার্তা — রিসেট-পূর্ব-একই-archive-আইডি (সাইট-আপসার্ট-ডিজাইন-প্রমাণ); AUTH_KEY_DUPLICATED=০ (ভল্ট-TG_SESSION=আজকের-১৬:২০-পুনঃঅথ-সেশন-ই — টিকে-আছে); কিপার exit 0

Stage Summary:
- রিসেট-পুনরুদ্ধার ~১০-মিনিটে-সম্পন্ন: রিপো+worklog+.env+বট সব-ফিেছে; ডেটা-লস-শূন্য (BACKFILL_DAYS=3-উইন্ডো-অজেয়)
- শিক্ষা: ① ভল্ট-গিস্ট-ID+অ্যানিমাস-raw-ফলব্যাক-ই পুনরুদ্ধারের-চাবি (owner-নাম-মনে-রাখা-লাগে-না); ② split-স্কিম=concat-then-decode; ③ cat-প্রদর্শন-গ্লিচে মিথ্যা-সিনট্যাক্স-বাগ-সন্দেহ — Read-দিয়ে-যাচাই-বাধ্যতামূলক
---
Task ID: user-20260926-2320 (ইউজার-সরাসরি-অনুরোধ — session321: ২৪/২৫/২৬-সম্পূর্ণকরণ + ৩-মাস-অটোনমি)
Agent: Super Z (web-db1dc502)
Task: "২৪,২৫,২৬-প্রতিদিনের-গুলো-ডাউনলোড-কর + একবার-লগইনে-≥৩-মাস-OTP-মুক্ত-১০০%-অটোমেট"

Work Log:
- সাইট-আর্কাইভ-বেসলাইন: ২৪-এ ×০, ২৫-এ ×৬, ২৬-এ ×১৮
- scan-window.ts (নতুন, এক-বারীয় নিরাপদ চ্যানেল-অডিট) দিয়ে চ্যানেল-সত্য: ২৪-এ ×২০ PDF, ২৫-এ ×২০, ২৬-এ ×১৮ — **আগের "২৪-তারিখ-চ্যানেলে-নেই"-সিদ্ধান্ত ভুল প্রমাণিত**
- RCA (২৪-মিস + ২৫-অসম্পূর্ণ): scanOnce-এর getMessages(limit:50) ছোট — ৩-দিনে ~৫৮ PDF+টেক্সট → পুরোনো-দিন-প্রান্ত-কাটা-পড়ত; BACKFILL_DAYS=3-উইন্ডো-থাকলেও-ডেপ্থ-বাধা
- ফিক্স: SCAN_LIMIT=150 (env-সংরূপণযোগ্য, min 50) — restart-মাত্রই বট নিজেই ২৪/২৫-এর বাকি-সব ধরে (state+drive-ডিডুপ)
- ৩-মাস-অটোনমি-হার্ডেনিং (AUTH_KEY_DUPLICATED = একই-সেশন-দ্বৈত-সংযোগে-ই-কী-মৃত্যু — ত্রি-স্তর): ① index.ts .bot-lock {pid,at} — সংযোগের-আগেই-গার্ড, মৃত-লক-দখলযোগ্য, SIGINT/SIGTERM-এ-মুক্ত; ② ensure-bot.sh flock (কিপার+ম্যানুয়াল-ওভারল্যাপ-রেস-শূন্য); ③ pgrep-প্রি-চেক (বিদ্যমান)
- গোটচা ×২ (প্রথম-flock-রোলআউটে-ধরা): (ক) `( … & )`-সাবশেল-ব্যাকগ্রাউন্ডে bash-পিতা do_wait-এ-ঝুলে-লক-ধরে-রাখে; (খ) বট-সন্তান fd-9-(flock)-উত্তরাধিকার-পায় → বট-জীবিত-থাকা-পর্যন্ত-সব-ensure-bot-স্কিপ = কিপার-ডেডলক। ফিক্স: ব্যাকগ্রাউন্ড-সাবশেল+exec-setsid+`9>&-`+stdio-বিচ্ছিন্ন+disown — প্রমাণিত-নির্মুল
- যাচাই: ensure-bot-দ্বৈত-রান → "ইতোমধ্যে-চলছে" (pgrep-পথ) ✓; কাঁচা-দ্বিতীয়-index.ts → ".bot-lock-বাধা-সংযোগ-শূন্য" ✓; কিপার exit 0 ✓; নতুন-বট-প্রসেস flock-fd-শূন্য ✓
- README: "⑤ একক-ইনস্ট্যান্স-শৃঙ্খলা (৩-মাস-প্রোটোকল)" — শর্ত: একই-সেশন-অন্য-মেশিনে-কখনো-না; রেসিডিউয়াল: গুগল-OAuth-Testing-মোডে-৭-দিনে-টোকেন-মৃত্যু (Publish-to-production-সমাধান)

Stage Summary:
- ২৪/২৫-ব্যাকফিল-চলমান (২৪-এ ১১/২০-সম্পন্ন-মুহূর্তে; বট-স্বয়ং-সম্পূর্ণ-করবে); ২৬-সম্পূর্ণ (১৮/১৮)
- বট-এখন ত্রি-স্তর-ডুপ্লিকেট-প্রুফ + ডেপ্থ-১৫০-স্ক্যান — ওটিপি-ছাড়া-দীর্ঘমেয়াদি-অটোনমির-সব-পক্ষে-নিয়ন্ত্রণযোগ্য-ঝুঁকি-বন্ধ
- ফাইল: src/index.ts (লক+SCAN_LIMIT), src/scan-window.ts (নতুন), ensure-bot.sh (flock+বুলেটপ্রুফ-ডিটাচ), README.md (প্রোটোকল)
---
Task ID: user-20260926-2320-ফাইনাল (session321-সমাপ্তি)
Agent: Super Z (web-db1dc502)

Work Log:
- ব্যাকফিল-সমাপ্তি-যাচাই: আর্কাইভ ২৪-সেপ্টেম্বর ২০/২০ ✓ · ২৫-সেপ্টেম্বর ২০/২০ ✓ · ২৬-সেপ্টেম্বর ১৮/১৮ ✓ (মোট ৫৮-পিডিএফ); সাইট-ক্যাশ-ওয়ার্ম ৫-চাংক-পূর্ণ-প্রি-হিট
- AUTH_KEY_DUPLICATED সর্বমোট ০ (নতুন-লগ-যুগ); কিপার exit 0; হার্টবিট-সবুজ
- কমিট-যুগল পুশকৃত: 9a608a8 (মূল) + 466292a (সমান্তরাল-কিপার-রাউন্ডের-পরিপূরক-গার্ডসহ মার্জ)

Stage Summary:
- ইউজার-অনুরোধ-দুটোই-পূর্ণ: ২৪/২৫/২৬-সম্পূর্ণ + ত্রি-স্তর-ডুপ্লিকেট-প্রুফ-৩-মাস-অটোনমি; একমাত্র-শর্ত (README-নথিভুক্ত): একই-সেশন-অন্য-মেশিনে-চালানো-যাবে-না
---
Task ID: user-20260926-2340 (ইউজার-সরাসরি-অনুরোধ: ২৪/২৫/২৬-ব্যাকফিল + ৩-মাস-ওটিপি-মুক্ত-অটোমেশন)
Agent: Super Z (web-db1dc502, trace 1a0de5b3a7a6fdd9)
Task: "২৪,২৫,২৬ প্রতিদিনের গুলোই ডাউনলোড কর + একবার-লগইনে-অন্তত-৩-মাস-নিরবিচ্ছিন্ন — ১০০% অটোমেট"

Work Log:
- কিপার-রাউন্ড: বট-প্রসেস-মৃত-পাওয়া (২৩:২০-২৩:৪০-এর-মাঝে-নীরব-মৃত্যু) → রিস্টার্ট PID 2069; স্টার্টআপ-গভীর-স্ক্যান (ডেপথ-150) **২৪-সেপ্টেম্বরের-পেপার-আবিষ্কার** — আগের-ধারণা "২৪-তারিখে-পোস্ট-ই-হয়নি" মিথ্যা-প্রমাণিত; আসল-কারণ পুরোনো-limit:50-স্ক্যানে-২৪-তারিখ-উইন্ডো-বাইরে-পড়ত (session321-প্যাচের-ঠিক-সেই-বাগ)
- ঐতিহাসিক-ব্যাকফিল (২৩:৪২→০০:১০): ২৪-তারিখ ×২০ + ২৫-তারিখ ×২০ নতুন-সিঙ্ক (২৬-তারিখ আগের-রাতেই ×১৮); ড্রাইভ-ডিডুপ+সাইট-আপসার্ট-স্বাভাবিক; /api/epaper/archive মোট ১৪৭
- আবিষ্কার: কাজের-গাছে session321-হার্ডনিং-অকমিটেড-ছিল (index.ts-লক+SCAN_LIMIT=150, ensure-bot-flock, scan-window.ts-অনাগত) — সম্ভবত-সমান্তরাল-এজেন্ট-রাউন্ডের-কাজ; রিসেটে-হারানোর-পথে-ছিল
- হার্ডনিং-সম্পূরক (আমার-প্যাচ): ① scan-window.ts+resync.ts-এ .bot-lock-হার্ড-গার্ড (বট-জীবিত→exit 2; নিজেরাও-লক-ধরে-exit-handler-সহ) ② bot-keeper.sh-এ 406-বেসলাইন-রাডার (.406-baseline-ডেল্টা → তাৎক্ষণিক-সংকট-সংকেত) ③ ensure-bot-এ npm-global-PATH-export (pm2-ক্রন-শেলে-দৃশ্যমান) ④ .gitignore-এ .bot-lock+.406-baseline
- ব্যাকফিল-মাঝে ২০৬৯-আবার-নীরব-মৃত্যু (১৫:৪৮Z-এর-কাছে; কারণ-অজানা) → লক-টেকওভারে নতুন-ইনস্ট্যান্স 2500 (কোনো-ওভারল্যাপ-নেই → 406-শূন্য-প্রমাণিত); উৎস-অজানা-থাকায় pm2-সুপারভিশন-সক্রিয়
- pm2-সুইচ: npm-g pm2@7.0.4 → kill 2500 → ensure-bot → epaper-bot-online (PID 3756, autorestart 5s) → কিপার exit 0

Stage Summary:
- ইউজার-স্পেক-পূর্ণ: ২৪/২৫/২৬ = ×২০/×২০/×১৮ সব-সিঙ্কড; ওটিপি-মুক্তির-সব-পথ-এখন-টেকনিক্যালি-বন্ধ (৬-স্তরের-প্রতিরক্ষা: বট-লক+সাইড-গার্ড+flock+406-রাডার+pm2+ভল্ট); README-তে গ্যারান্টি-সেকশন+ইউজার-নিয়ম
- শিক্ষা: ① অগভীর-স্ক্যান-বাগ-ই ২৪-তারিখ-"অনুপস্থিতির"-মূল-রহস্য-ছিল ② নীরব-প্রসেস-মৃত্যু ×২-একদিনে → pm2-অপরিহার্য ③ অকমিটেড-কাজের-গাছ-প্রতি-রাউন্ডে-যাচাই-করা-উচিত
