...
>>>>>>> df6f721 (feat(session147): ফোরাম ডিরেক্টরি লঞ্চার (FB ৯-ডট প্যারিটি) + ফিড লেফট-রেল — 'আরও'-মেগামেনু IA-সংস্কার — ইউজার-প্রস্তাব দুই-পদ্ধতি একসাথে: ① ৯-ডট ট্রিগার → ৫৬০px ফ্লোটিং অ্যাপ-প্যানেল (৩-ডোমেইন × ১২-আইটেম: জ্ঞান-ও-সাহিত্য-কর্নার/ফোরাম-ও-প্রাতিষ্ঠানিক/দৈনন্দিন-ফিচার-ও-স্মৃতি; প্রতি আইটেমে Title+Subtitle + টোন-স্কুইর্কল; মেগামেনুর ঘোষণা/বিজ্ঞপ্তি ও আয়োজন/ইভেন্ট href-ডুপ্লিকেট এক-আইটেমে সংযুক্ত) ② ফিড লেফট-রেল ≥1200px (প্রোফাইল-রো + ৮-শর্টকাট, ই-পেপার ব্র্যান্ড-হাইলাইট, sticky+max-h-scroll) ③ helpers/dir-launcher.js single-source রেজিস্ট্রি (notifGroups-রীতি — হেডার+layout+রেল তিন-সারফেস অটো-সিঙ্ক; নতুন-আইটেম=রেজিস্ট্রি-কেবল) ④ পাবলিক-টপবারেও (layout.ejs) লঞ্চার — আগে পাবলিক-পেজে কোনো ডিরেক্টরি-মেনুই ছিল না (নতুন-সক্ষমতা) ⑤ dir-launcher.js ইঞ্জিন — aria-expanded/haspopup/controls + Escape-ফোকাস-ফেরত + বাইরে-ক্লিক-বন্ধ (main.js-মিনিফাইড-সার্জারি-এড়ানো; toggleMega/closeMega মৃত-নিরীহ-অক্ষত) ⑥ tokens.css --lf-dlx-* ×৬ (amber/gold/cyan/violet/pink/slate — হোয়াইট-আইকন কনট্রাস্ট 600-700-শেড; tokens.css ratchet-তালিকাবহির্ভূত) ⑦ style.css/dashboard.css session147-EOF-ব্লক (টোকেন-শুধু — hex-শূন্য; গোটচা: প্রথম-ব্লকে ২×#fff র্যাচেট-ফেইল করেছিল → var(--lf-white)); <992px লুকানো — মোবাইল-সাইডবার কভার। E2E (:3190 আইসোলেটেড pristine ত্রি-seed): ডেস্কটপ ৩-কলাম 212/776/300 ✓ লঞ্চার ১২-আইটেম/৩-সেকশন/aria ✓ Escape+ফোকাস-ফেরত ✓ বাইরে-ক্লিক ✓ /epaper-নেভ ✓ পাবলিক /articles+/ ✓ 390px rail/dlx-none overflow-শূন্য ×৩ ✓ কনসোল-০ ✓ স্ক্রিনশট ×৪; রিগ্রেশন: guard ✓ (ratchet) inspect-audit ✓ cursor 25/25 ✓ (গোটচা: ডিফল্ট :8080 — BASE-আর্গ) brace-০ ×৩ ✓ node --check ×৩ ✓ EJS ×৩ ✓। docs: PLANS session147-নোট (চুক্তি ×৫) + PROJECT §১৪৭ + worklog ×২ — পরের-এজেন্ট session148 থেকে)
