...
> সঙ্গী-নোটিশ: [`AGENT-NOTICE.md`](./AGENT-NOTICE.md) (উচ্চ-প্রাধান্য, চেকলিস্ট-সহ) — দুটোই-পড়ো।
...
2. পুরনো `lekhok-forum-next/` (Next.js 16 ফেসবুক-স্টাইল প্রোটোটাইপ, ১৯৩-ফাইল) ২০২৬-০৯-২২ ব্যবহারকারীর
   ...
   ইতিহাস-পাঠের-জন্য-কেবল: `git show archive/lekhok-forum-next:<path>` — কিন্তু সেখান-থেকে-কোড-পোর্ট-ব্যাক **নয়**;
   দরকার-হলে Express-এ **নতুন-করে** ইমপ্লিমেন্ট করো।
...
- Vercel-থেকে-Next.js-প্রজেক্ট-অপসারিত (NEXT-REMOVE, ২০২৬-০৯-২২) — এখন-আর-কোনো-Next-ডিপ্লয়-নেই।
...
4. লোকাল `lekhok.db` = প্রোডাকশন-কপি — রানিং-সার্ভার-থাকলে reset-স্ক্রিপ্ট-চালাবে-না (debounced saveDb ওভাররাইট-ঝুঁকি)।
5. ডাইনামিক-ফর্মে sidebar CSRF-প্যাচার পড়ে-না → ফর্ম-URL-এ `?_csrf=` ম্যানুয়াল-যোগ করতে-হয় (NEXT-REMOVE-গোটচা)।
6. **Support-Center** Next-থেকে-Express-এ-পোর্ট-সম্পন্ন (fd13763): `/admin/support-center` + `/admin/super/support-settings` + `/api/support/my-reports` + মেসেঞ্জার-মিরর — Next-এর-কোনো-ফিচার-আর-মিসিং-নেই; নতুন-কাজ-সব-এখানেই।
