...
2. **stash→pull→pop-এ style.css UU-কনফ্লিক্টে `=======`-দ্বৈত-লাইন** (upstream-এর hunk-শেষে `=======` + stash-এর `=======` পাশাপাশি) — union-রিজলভে দুই-মার্কার-ই সরাতে হয়; শুধু `<<<<<<<`/`>>>>>>>` সরালে অবশিষ্ট-`=======` CSS-পার্স-ব্রেক হয় না কিন্তু কমেন্ট-ভেদে প্রবেশ করে।
...
## Cross-Agent Note — Session 137 (rate-limit QA-escape + ফিড accepted-ব্যাজ + answer_accepted টোনাল-আইকন)
