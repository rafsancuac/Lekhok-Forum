...
>>>>>>> e6db804 (feat(session103): যোগাযোগ-ফর্ম 'কখনো-কাজ-করেনি' ব্রেকেজ-ফিক্স (CSRF × ক্যাশেবল-পেজ) + রেট-লিমিট + প্রভোস্ট-সার্চ/কপি/মোনোগ্রাম + আজ-খোলা-ব্যাজ + JSON-LD + স্টাইল-পলিশ — ① মূল-বাগ: ফর্মে _csrf-ফিল্ডই নেই + /contact ক্যাশেবল-পাবলিকে রেন্ডার-টোকেন এফেমেরাল → urlencoded-POST সবসময় 403/303-?csrf=1 (session42-থেকে কখনো সেভ হয়নি; success-strip ডেড-কোড)। ফিক্স: ফর্মে _csrf-হিডেন + fetch-ইন্টারসেপ্ট (403-এ fresh ?_u= GET-টোকেন-রিফ্রেশ-রিট্রায়, XTransformPort-প্রিজার্ভ) + no-JS প্ল্যাটফর্ম-রিকভারি-পাথ ② api.js: রেট-লিমিট ৫/১০মি/IP (প্রুন-গার্ড) + wantsHtml-ডিটেক্ট (303 ?success=|error= বনাম {ok}-JSON) + ক্ল্যাম্প + error-strip (pages.js) ③ প্রভোস্ট-সার্চ (data-search-ফিল্টার+বাংলা-কাউন্ট+clear+empty+auto-এক্সপ্যান্ড) + কপি-টু-ক্লিপবোর্ড (fallback+✓-ফিডব্যাক) + মোনোগ্রাম-টাইল (tint-সাইকেল) ④ 'আজ খোলা' ব্যাজ (data-days/data-closed দিন-পার্স+রেঞ্জ; is-today-রো + বর্ডার-টপ আজ-চিপ + পালস-ডট) ⑤ ContactPoint JSON-LD (+880) ⑥ স্টাইল: শাইন-সুইপ/গ্রেডিয়েন্ট-ট্রিম/জেব্রা-টেবিল+ইনসেট-হোভার/পালস-ডট/focus-visible×৮/640px/reduced-motion। E2E: fetch→inline-success+DB-রো ✓ no-JS ২-স্টেপ→success ✓ [200,200,200,429] ✓ সার্চ ২/০/১৫ ✓ কপি ✓ আজ-ব্যাজ ✓ JSON-LD ✓ ১৩-পেজ+২-API ✓ 390px-০ ✓ কনসোল-০ ✓। গোটচা: CSS-এডিটের পর AV-রিস্টার্ট আবশ্যক; rg -r রিপ্লেস-ফ্ল্যাগ-বিভ্রম; sandbox auto-commit-প্রতিষেধক .gitignore (আলাদা কমিট))
