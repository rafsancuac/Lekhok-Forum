...
- **Vercel-কোটা-স্তর (s276-webhook-গোটচার সংযোজন):** `POST /v13/deployments` ফ্রি-টিয়ারে **দিনে ১০০-সীমা** — সমান্তরাল-এজেন্ট-রাউন্ডগুলো মিলে কোটা শেষ করে দিলে 402 `api-deployments-free-per-day`; **fallback = git-push-webhook** (যেকোনো নতুন কমিট-পুশ webhook পুনঃফায়ার করে — docs-কমিট-ই যথেষ্ট); কোটা-reset epoch response-এর limit.reset-এ
