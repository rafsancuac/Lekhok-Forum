...
// ── সেশন ৭২: whoami — ক্যাশড-অ্যানোনিমাস HTML-এ লগড-ইন ইউজার ধরার প্রোব ──────
// Vercel Edge কুকি-নির্বিশেষে একই ক্যাশ-কপি দেয়, তাই লগড-ইন ইউজার মাঝে মাঝে
// পাবলিক পেজে লগ-আউট ভার্সন পেতে পারে। auth-sync.js এই টিনি এন্ডপয়েন্টে চেক
// করে প্রয়োজনে ?_u=<ts> কুয়েরি-সহ রিফ্রেশ করে (কুয়েরি → ক্যাশ-বাইপাস)।
// শুধু social-user সেশন গণ্য — অ্যাডমিন-সেশনে পাবলিক পেজ মূলত লগ-আউট-ভিউ-ই
// (user-menu নেই), তাই অ্যাডমিনের জন্য রিসিঙ্ক-রিফ্রেশ হবে না।
