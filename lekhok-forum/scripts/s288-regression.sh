#!/bin/bash
# s288-regression.sh — session288 পূর্ণ-রিগ্রেশন রানার (s260..s288 + role-policy + guard:design + audit:views)
...
SUITES=(s260-eventsfilter s261-resfilter s262-mufilter s263-mdfilter s264-adfilter s265-acfilter \
        ...
        s283-calmonth s284-calyear s285-calkey s286-calgrid s287-calday s288-calaria)
TOTAL=0; BAD=()
for S in "${SUITES[@]}"; do
  TOTAL=$((TOTAL+1))
