...
const DEFAULTS = {
  // হোম — হিরো
  home_hero_eyebrow: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়',
  home_hero_title: 'সুপ্ত প্রতিভা বিকশিত হোক',
  home_hero_title_accent: 'লেখনীর ধারায়',
  home_hero_sub: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়, একটি শিক্ষামূলক, অলাভজনক ও অরাজনৈতিক সংগঠন। তরুণ সমাজকে লিখালিখির জগতে নিয়ে এসে তাদের বুদ্ধিবৃত্তিক বিকাশ ঘটিয়ে দেশ ও জাতির সমৃদ্ধির লক্ষ্যে যোগ্য ও সুনাগরিক হিসেবে গড়ে তোলাই আমাদের প্রত্যয়।',
  ...
  home_mission_lead: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয় একটি শিক্ষামূলক, অলাভজনক এবং অরাজনৈতিক সংগঠন, যা তরুণ সমাজকে লিখালিখির জগতে নিয়ে এসে তাদের বুদ্ধিবৃত্তিক বিকাশ ঘটিয়ে দেশ ও জাতির সমৃদ্ধির লক্ষ্যে তাদেরকে যোগ্য ও সুনাগরিক হিসেবে গড়ে তোলে।',
  // হোম — ৮টি ফিচার কার্ড
  ...
  about_header_sub: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়। পরিচিতি, মূলমন্ত্র, লক্ষ্য-উদ্দেশ্য ও কার্যাক্রম',
  about_identity_eyebrow: 'আমাদের পরিচয়',
  about_identity_t1: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম,',
  about_identity_accent: 'চট্টগ্রাম বিশ্ববিদ্যালয়',
  about_identity_text: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম একটি শিক্ষামূলক, অলাভজনক এবং অরাজনৈতিক সংগঠন, যা তরুণ সমাজকে লিখালিখির জগতে নিয়ে এসে তাদের বুদ্ধিবৃত্তিক বিকাশ ঘটিয়ে দেশ ও জাতির সমৃদ্ধির লক্ষ্যে তাদেরকে যোগ্য ও সুনাগরিক হিসেবে গড়ে তোলে। চট্টগ্রাম বিশ্ববিদ্যালয়ে যারা পত্রিকায় লিখেন কিংবা লিখতে চান, তাদেরকে সঠিকভাবে লিখার পদ্ধতি, কালাকৌশল এবং সংশ্লিষ্ট বিষয়ে পরামর্শ দিতে বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চবি শাখা দৃঢ়প্রত্যয়ী। সদস্যদের নিয়ে নিয়মিত কর্মশালা আয়োজন এবং লিখালিখির যাবতীয় সমস্যা সমাধানে অভিজ্ঞরা নিজ তত্ত্বাবধানে রেখে সদস্যদের দেখাশোনা করে থাকেন।',
  ...
  committee_header_sub: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়। কার্যবর্ষভিত্তিক পূর্ণাঙ্গ কার্যনির্বাহী কমিটি',
  committee_term_label: 'কার্যবর্ষ',
  advisory_header_eyebrow: 'পরামর্শদাতা',
  advisory_header_title: 'উপদেষ্টা পরিষদ',
  advisory_header_sub: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়। সংগঠনের পরামর্শদাতামণ্ডলী',
  ...
  notices_header_sub: 'বাংলাদেশ তরুণ কলাম লেখক ফোরামের সর্বশেষ খবর ও আপডেট',
  ...
  press_header_sub: 'বিভিন্ন জাতীয় ও স্থানীয় পত্রিকায় বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়কে নিয়ে প্রকাশিত সংবাদসমূহ',

  // হেডার ও ফুটার
  header_brand_line1: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম',
  header_brand_line2: 'চট্টগ্রাম বিশ্ববিদ্যালয়',
  header_btn_login: 'লগইন',
  header_btn_register: 'রেজিস্ট্রেশন',
  footer_brand_desc: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয় শাখা, একটি শিক্ষামূলক, অলাভজনক ও অরাজনৈতিক সংগঠন। মূলমন্ত্র: তারুণ্যের শাণিত কলমে আলোকিত ধরনী।',
  ...
  footer_copyright: 'বাংলাদেশ তরুণ কলাম লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়। সর্বস্বত্ব সংরক্ষিত।',
