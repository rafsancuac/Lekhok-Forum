    ...
    groups: [
      ...
      },
      {
        key: 'conditions', label: 'সদস্য হওয়ার শর্তাবলি', fields: [
          ...
          { key: 'about_step5_title', label: 'ধাপ ৫ | শিরোনাম', type: 'text' },
          { key: 'about_step5_text', label: 'ধাপ ৫ | বিবরণ', type: 'textarea' },
          { key: 'about_step6_title', label: 'ধাপ ৬ | শিরোনাম', type: 'text' },
          { key: 'about_step6_text', label: 'ধাপ ৬ | বিবরণ', type: 'textarea' },
          { key: 'about_step7_title', label: 'ধাপ ৭ | শিরোনাম', type: 'text' },
          { key: 'about_step7_text', label: 'ধাপ ৭ | বিবরণ', type: 'textarea' },
          { key: 'about_step8_title', label: 'ধাপ ৮ | শিরোনাম', type: 'text' },
          { key: 'about_step8_text', label: 'ধাপ ৮ | বিবরণ', type: 'textarea' },
...
// ═══ সেশন ৪৯: প্রতি পেজে SEO (meta title/description) ফিল্ড ═══
// প্রতিটি রিয়েল পেজে (layout বাদ — সেটি হেডার/ফুটার, নিজস্ব পেজ নয়) একটি
// `seo` গ্রুপ যোগ করি। অ্যাডমিন /admin/content-এ এই ফিল্ড এডিট করলে
// header.ejs-এর <title>/<meta description> সেটি ব্যবহার করে (server.js-এ
// path→page ম্যাপিংয়ের মাধ্যমে)। খালি রাখলে DEFAULTS (নিচের মান) ব্যবহার হয়।
const SEO_DEFAULTS = {
  home:      { title: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয় শাখা — একটি শিক্ষামূলক, অলাভজনক ও অরাজনৈতিক সংগঠন। মূলমন্ত্র: তারুণ্যের শাণিত কলমে আলোকিত ধরনী।' },
  about:     { title: 'পরিচিতি | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয় শাখার পরিচিতি, লক্ষ্য-উদ্দেশ্য, কার্যাক্রম ও সদস্য হওয়ার শর্তাবলি।' },
  contact:   { title: 'যোগাযোগ | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয় শাখায় যোগাযোগের ঠিকানা, ফোন, ইমেইল ও সোশ্যাল মাধ্যম।' },
  committee: { title: 'কার্যনির্বাহী কমিটি | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের কার্যবর্ষভিত্তিক পূর্ণাঙ্গ কার্যনির্বাহী কমিটি।' },
  advisory:  { title: 'উপদেষ্টা পরিষদ | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের উপদেষ্টা পরিষদ — সংগঠনের পরামর্শদাতামণ্ডলী।' },
  members:   { title: 'সদস্য পরিচিতি | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের নেতৃত্ব ও সকল সদস্যের পরিচিতি।' },
  team:      { title: 'সম্পূর্ণ টিম | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের কেন্দ্রীয় কমিটি, উপদেষ্টা পর্ষদ, প্রতিষ্ঠাতা ও শাখা টিম।' },
  notices:   { title: 'বিজ্ঞপ্তি | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের সর্বশেষ খবর, বিজ্ঞপ্তি ও আপডেট।' },
  events:    { title: 'ইভেন্ট | লেখক ফোরাম', desc: 'লেখক ফোরামের আসন্ন ও অতীত ইভেন্ট — সেমিনার, কর্মশালা, সাংস্কৃতিক সন্ধ্যা ও বিশেষ আয়োজন।' },
  gallery:   { title: 'গ্যালারি | লেখক ফোরাম', desc: 'লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়ের ইভেন্ট ও কার্যক্রমের ছবির সংগ্রহ।' },
  resources: { title: 'রিসোর্স | লেখক ফোরাম', desc: 'লেখক ফোরামের ফেলোশিপ, লেখালেখির টিপস ও গুরুত্বপূর্ণ ফাইল ও রিসোর্স।' },
  articles:  { title: 'প্রকাশিত লেখা | লেখক ফোরাম', desc: 'লেখক ফোরামের সদস্যদের প্রকাশিত কলাম, চিঠি ও প্রবন্ধ।' },
  press:     { title: 'পত্রিকায় আমাদের নিউজ | লেখক ফোরাম', desc: 'বিভিন্ন জাতীয় ও স্থানীয় পত্রিকায় লেখক ফোরাম, চট্টগ্রাম বিশ্ববিদ্যালয়কে নিয়ে প্রকাশিত সংবাদ।' }
};

for (const p of PAGES) {
  if (p.key === 'layout') continue;           // হেডার/ফুটার নিজস্ব পেজ নয়
  const seo = SEO_DEFAULTS[p.key] || { title: p.label + ' | লেখক ফোরাম', desc: '' };
  p.groups.push({
    key: 'seo', label: 'SEO (সার্চ ইঞ্জিন)', fields: [
      { key: p.key + '_meta_title', label: 'Meta title', type: 'text', hint: 'ব্রাউজার ট্যাব ও সার্চ ফলাফলে দেখানো শিরোনাম' },
      { key: p.key + '_meta_desc', label: 'Meta description', type: 'textarea', rows: 2, hint: 'সার্চ ফলাফলে দেখানো সংক্ষিপ্ত বিবরণ' }
    ]
  });
}
...
const DEFAULTS = {
  ...
  about_step4_text: 'পরবর্তীতে ৩ মাস পর্যন্ত আপনাদের লেখালেখি এবং সাংগঠনিক কর্মকাণ্ড পর্যবেক্ষণ করে লেখালেখির পাশাপাশি সাংগঠনিক কার্যক্রমে সক্রিয় আগ্রহীদের সদস্য পদ দেওয়া হবে।',
  about_step5_title: 'নিয়মিত লেখা জমা',
  about_step5_text: 'সদস্যপদ নিশ্চিত হওয়ার পর প্রতি মাসে কমপক্ষে একটি লেখা সংগঠনের পত্রিকায় জমা দেওয়া সদস্যের দায়িত্ব।',
  about_step6_title: 'কর্মশালা ও সেমিনার',
  about_step6_text: 'লেখালেখির নিয়মিত কর্মশালা, সেমিনার ও পিয়ার-ফিডব্যাক সেশনে সক্রিয়ভাবে অংশগ্রহণ করতে হবে।',
  about_step7_title: 'মাসিক সভায় উপস্থিতি',
  about_step7_text: 'শাখার মাসিক সভা এবং সাংগঠনিক কর্মকাণ্ডে নিয়মিত উপস্থিত থাকা সদস্যের কর্তব্য।',
  about_step8_title: 'পরিচয়পত্র প্রাপ্তি',
  about_step8_text: 'সব ধাপ সফলভাবে সম্পন্ন করার পর সদস্য সংগঠনের পরিচয়পত্র ও সদস্য নম্বর প্রাপ্ত হবেন।',
...
// সেশন ৪৯: SEO ডিফল্ট মান DEFAULTS-এ merge (এখানে DEFAULTS ঘোষিত হয়ে গেছে)
for (const p of PAGES) {
  if (p.key === 'layout') continue;
  const seo = SEO_DEFAULTS[p.key] || { title: p.label + ' | লেখক ফোরাম', desc: '' };
  if (DEFAULTS[p.key + '_meta_title'] === undefined) DEFAULTS[p.key + '_meta_title'] = seo.title;
  if (DEFAULTS[p.key + '_meta_desc'] === undefined) DEFAULTS[p.key + '_meta_desc'] = seo.desc;
}
