...
function seedIfEmpty() {
  ...
  gallery.forEach(g => prepare('INSERT INTO gallery (title, image_url, caption, event_date) VALUES (?, ?, ?, ?)').run(...g));
  ...
  resources.forEach(r => prepare('INSERT INTO resources (title, content, category, author, tags) VALUES (?, ?, ?, ?, ?)').run(...r));
