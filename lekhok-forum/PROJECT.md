...
> **সেশন ৫৮-আপডেট:** সাইট এখন ডার্ক-গ্রিন গ্র্যাডিয়েন্ট থিমে (`linear-gradient(132deg,#04251c,#064e3b,#0a1f44)` পেজ-ব্যাকগ্রাউন্ড, কার্ড `#0B3327`, অ্যাকসেন্ট `#34D399` লাইট-সবুজ, টেক্সট `#E6F4EC`)। নতুন কোনো কম্পোনেন্ট বানালে এই প্যালেট ফলো করুন; লাইট-সারফেস (`#fff`/`#f8fafc`) আর ব্যবহার নয়।
