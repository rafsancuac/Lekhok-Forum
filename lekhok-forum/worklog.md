...
>>>>>>> 559ddf9 (feat(session153): FB-স্টাইল রিচ-কম্পোজার + ইন্টেলিজেন্ট মিডিয়া-কোলাজ — ইউজার-স্পেক A-to-Z (RCA: স্পেক Next.js/React-ধাঁচে লেখা, EJS-স্ট্যাকে পোর্ট-ই হয়নি — ফিড-কম্পোজার ছিল session100-বক্স-মডাল = ইউজারের 'বক্স সিস্টেম' অভিযোগের উৎস) — (১) DB: posts-এ rich_content/background_color(fbg1..8)/feeling/location/audience + post_images.media_type (alt+LATER_COLUMNS+schema ত্রি-মিরর) + db.setPostMedia153 (২) helpers/rich-sanitize.js — contentEditable-HTML হোয়াইটলিস্ট-স্যানিটাইজার (on*/script/img/js-url ব্লক; a[href]+text-align-কেবল; unit-প্রমাণিত) (৩) POST /api/posts/compose (JSON: স্যানিটাইজ+অটো-টাইটেল ≤৮০+ডুপ-গার্ড+মেনশন-নোটিফ) + POST /upload-media (image 8MB/video 64MB/audio 16MB মাইম-হোয়াইটলিস্ট + middleware.storeBufferMedia153) (৪) ফিড: buildFeedSql কলাম ×৫ ৩-শাখা UNION-সমতা + decorateFeed media-ব্যাচ → item.media153 + views/partials/fb-media-collage.ejs — ১=ফুল(ছবি/video/অডিও-কার্ড)/২=৫০-৫০/৩=১+২/৪=১+৩/৫+=+N-ওভারলে(toBn) — post-gallery.js-লাইটবক্স-পুনঃব্যবহার (video/audio/+N-গার্ড) (৫) FeedPostCard rich-শাখা — শিরোনাম-বিহীন ইনলাইন-বডি + fb-bg153-গ্রেডিয়েন্ট + অনুভূতি/লোকেশন/অডিয়েন্স-চিপ + কোলাজ; article-single ব্যানার+কোলাজ (৬) অডিয়েন্স-এনফোর্সমেন্ট ত্রি-সারফেস — shared-posts.filterByAudience153 + mutualFollowIds153 (FRIENDS=মিউচুয়াল-ফলো; ONLY_ME; অজানা=লুকান) + সিঙ্গেল-404-গার্ড; buildFeedSql-হট-পথ-অস্পৃশ্য (JS-ফিল্টার-ডিজাইন) (৭) কম্পোজার-মোডাল পূর্ণ-প্রতিস্থাপন — বর্ডারহীন contentEditable ক্যানভাস (ইনপুট-বক্স-শূন্য) + MS-অফিস-টুলবার ১২-টুল (queryCommandState-অ্যাকটিভ + mousedown-preventDefault-চুক্তি) + পেস্ট=প্লেইন-টেক্সট + 'Aa'-প্যালেট ৮-গ্রেডিয়েন্ট (মিডিয়া-উপস্থিতিতে অটো-বন্ধ) + মিডিয়া-পিকার/ড্র্যাগ-ড্রপ→আপলোড→কোলাজ-প্রিভিউ (ফিড-মিনি-মিরর, per-রিমুভ) + অডিয়েন্স-সিলেক্টর + অনুভূতি-গ্রিড ×৮ + চেক-ইন + থ্রি-ডট→২য় স্লাইড-ইন সাব-মেনু (ব্যাক-বাটন+শিরোনাম-সোয়াপ) + খসড়া-অটোসেভ lfCpm153 + ফোকাস-ট্র্যাপ + Ctrl-সাবমিট + 390px (৮) 🐛 লাইভ-ধরা: অনুপস্থিত-audience → লিটারাল-'undefined'-স্টোর (String(x||D)-ভ্যালিডেট-কিন্তু-String(x)-সেভ প্যাঁচ) → অতিথি-ফিডে নীরবে-অদৃশ্য — নরমালাইজ→হোয়াইটলিস্ট-ক্রমে ফিক্স + E2E-রিগ্রেশন-গার্ড (৯) কম্পোনেন্ট-CSS গ্লোবাল-চুক্তি — fb-col153/rich153/bg153 style.css-এ (article-page dashboard.css লোড হয় না), fbm-* dashboard.css-এ — টোকেন-শুধু hex-শূন্য। E2E (tests/lf153-e2e.sh) **49/49 ALL GREEN** + role-policy **239/239** + cursor 25/25 + guard ✓ + audit:views ✓ + brace-0 + EJS ×৪ + স্ক্রিনশট ×৪। docs: PROJECT §১৫৩ + PLANS session153-নোট (চুক্তি ×৭ + হারনেস-লেসন ×৪ + প্রস্তাব ×৫) + worklog ×২ — পরের-এজেন্ট session154 থেকে)
