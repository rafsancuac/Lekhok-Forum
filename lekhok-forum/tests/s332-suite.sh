...
grep -q "a324.download = 'lekhok-copy-history-' + iso333.slice(0, 10) + '-' + iso333.slice(11, 19).replace(/:/g, '') + ex332a;" "$APP/admin/views/admin/home-reorder.ejs" && grep -q "a329.download = 'lekhok-preview-' + iso333b.slice(0, 10) + '-' + iso333b.slice(11, 19).replace(/:/g, '') + ex332b;" "$APP/admin/views/admin/home-reorder.ejs" && ok "home-reorder.ejs: ফাইলনাম-সাইট-দ্বয় মোড-সম্মত ('.txt'-হার্ডকোড-মোছা)" || bad "home-reorder.ejs: ফাইলনাম-অমিল"
