...
[ "$(grep -o "is-real307" "$APP/views/partials/home/feed.ejs" | wc -l | tr -d ' ')" = "4" ] && ok "feed.ejs: is-real307-রো-মার্ক ×৪ (২-গ্রুপ × ২-হাফ)" || bad "feed.ejs: রো-মার্ক-গণনা=$(grep -o 'is-real307' "$APP/views/partials/home/feed.ejs" | wc -l | tr -d ' ')"
