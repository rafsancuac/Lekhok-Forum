...
DCJ=$(unjj "$DC")
if [ "$(jf ba "$DCJ")" = "1" ] && [ "$(jf cls36 "$DCJ")" = "true" ] && [ "$(jf cls37b "$DCJ")" = "true" ] && [ "$(jf cls37 "$DCJ")" = "true" ] && [ "$(jf a "$DCJ")" = "9" ] && [ "$(jf al1 "$DCJ")" = "0.22" ] && [ "$(jf al2 "$DCJ")" = "0.22" ]; then ok "ই২ই: দ্বি-শ্রেণি-ক্যাসকেড-প্রাধান্য (RL3-পুনঃপ্রয়োগ-শ্রেণি-অটুট + ব্যাচে hr336-batched-যুক্ত → দ্বি-শ্রেণি-সহাবস্থানে al1=al2=০.২২ — restored-২২%-প্রাধান্য cascade-চুক্তি-লাইভ-প্রমাণ + load()-applied=৯-সর্ব-স্ন্যাপশট)"; else bad "ই২ই: $(unjj "$DC")"; fi
...
OVJ=$(unjj "$OV")
if [ "$(jf o "$OVJ")" = "true" ] && [ "$(jf li "$OVJ")" = "9" ] && [ "$(jf r "$OVJ")" = "9" ]; then ok "ই২ই: ওভারলে-৯-সারি (স্থায়ীকরণ-রো-গণনা-অস্পৃশ্য — হিন্ট-কেবল-পুনঃপ্রয়োগ-প্রমাণ — hr343)"; else bad "ই২ই: $(unjj "$OV")"; fi
